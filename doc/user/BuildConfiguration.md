...
|       ignoreHttps                                                                           |       `boolean`      | Whether or not the source URI can be fetched over plain http instead of https.                                                                                 | *Optional* | `false`                           |  2.10 |
|       ignoreZipExtension                                                                    |       `boolean`      | Whether or not the source URI should be treated as a ZIP archive even if the URI has no `.zip` extension or the server does not return a zip content-type.     | *Optional* | `false`                           |  2.10 |

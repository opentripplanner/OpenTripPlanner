...
|    [routeToCentroidStopPlaceIds](#nd_routeToCentroidStopPlaceIds)        |  `string[]` | List stop places that should route to centroid.                                                                                                                | *Optional* |                                   |  2.6  |
...
|       [routeToCentroidStopPlaceIds](#tf_1_routeToCentroidStopPlaceIds)   |  `string[]` | List stop places that should route to centroid.                                                                                                                | *Optional* |                                   |  2.6  |
...
<h3 id="nd_routeToCentroidStopPlaceIds">routeToCentroidStopPlaceIds</h3>
...
<h3 id="tf_1_routeToCentroidStopPlaceIds">routeToCentroidStopPlaceIds</h3>

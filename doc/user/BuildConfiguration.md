...
|       includeOsmSubwayEntrances                                          |      `boolean`     | Whether to include subway entrances from the OSM data. Overrides the value specified in `osmDefaults`.                                                         | *Optional* | `false`                           |  2.2  |
...
|    includeOsmSubwayEntrances                                             |      `boolean`     | Whether to include subway entrances from the OSM data.                                                                                                         | *Optional* | `false`                           |  2.2  |

...
| [carsAllowedStopMaxTransferDurationsForMode](#carsAllowedStopMaxTransferDurationsForMode) | `enum map of duration` | This is used for specifying a `maxTransferDuration` value for bikes and cars to use with transfers between stops that have trips with cars.                    | *Optional* |                                   |  2.7  |
...
<h3 id="carsAllowedStopMaxTransferDurationsForMode">carsAllowedStopMaxTransferDurationsForMode</h3>

**Since version:** `2.7` ∙ **Type:** `enum map of duration` ∙ **Cardinality:** `Optional`   
**Path:** /   

...
Note that version numbers like `v2.1.0-rc1` or `v2.10.0-SNAPSHOT` refer to development builds _
before_ the release version `v2.10.0`. The existence of a build `vX.Y.Z-SNAPSHOT` does not mean that
...
the proper URL for the release you want. For example, release 2.10.0 will be found at
`https://repo1.maven.org/maven2/org/opentripplanner/otp-shaded/2.10.0/otp-shaded-2.10.0-shaded.jar`.

...
Note that version numbers like `v2.1.0-rc1` or `v1.8.1-SNAPSHOT` refer to development builds _
before_ the release version `v1.8.1`. The existence of a build `vX.Y.Z-SNAPSHOT` does not mean
...
the proper URL for the release you want. For example, release 1.8.1 will be found
at `https://repo1.maven.org/maven2/org/opentripplanner/otp-shaded/1.8.1/otp-shaded-1.8.1-shaded.jar`.

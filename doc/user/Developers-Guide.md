...
* Fix typos and improve the documentation within the `/docs/user` directory of the project (details
  below).
...
The documentation files are in Markdown format and are in the `/docs/user` directory under the root of

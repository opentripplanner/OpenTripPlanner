...
- Share GBFS per-network configuration between the vehicle rental sandboxes in `otp-config.json`, and make the build-time geofencing sandbox manifest-driven as `vehicleRentalGraphBuilder`

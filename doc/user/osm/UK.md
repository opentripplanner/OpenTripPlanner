...
| `highway=trunk; cycleway=opposite_lane`                 | `ALL`                    | 2.5         | 2.5         |
| `highway=trunk_link; cycleway=opposite_lane`            | `ALL`                    | 2.06        | 2.5         |
| `highway=trunk; cycleway=track`                         | `ALL`                    | 0.95        | 2.5         |
| `highway=trunk_link; cycleway=track`                    | `ALL`                    | 0.85        | 2.5         |
| `highway=trunk; cycleway=opposite_track`                | `ALL`                    | 2.5         | 2.5         |
| `highway=trunk_link; cycleway=opposite_track`           | `ALL`                    | 2.5         | 2.5         |

...
feature flag to turn it _on_ should only be enabled if you are routing using the norwegian data set.
...
Note! This looks at origin and destination coordinates in addition to the feature flag to enable the
second search. It is automatically enabled if:

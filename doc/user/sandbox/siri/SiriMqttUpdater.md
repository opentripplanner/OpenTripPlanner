...
HBT, Hamburg, Germany jessica.koehnke@hbt.de

## Documentation

This updater consumes SIRI real time information over an asynchronous MQTT feed by subscribing to an
MQTT topic.
...
To enable the SIRI-ET MQTT updater you need to add it to the updaters section of the
`router-config.json`.

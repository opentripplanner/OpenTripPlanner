...
|    [filterDirectFlexByEarliestDeparture](#rd_if_filterDirectFlexByEarliestDeparture)                         |        `boolean`       | Filter direct flex results by the earliestDepartureTime of the search window.                                                                  | *Optional* | `true`           |  2.7  |
...
Filter direct flex results by the earliestDepartureTime of the search window.

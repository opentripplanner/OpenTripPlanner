...
|    [removeTransitWithHigherCostThanBestDirect](#rd_if_removeTransitWithHigherCostThanBestDirect) | `cost-linear-function` | Limit function for generalized-cost computed from direct itineraries applied to transit itineraries.                                                     | *Optional* | `"1m + 1.30 t"`  |  2.4  |
...
<h3 id="rd_if_removeTransitWithHigherCostThanBestDirect">removeTransitWithHigherCostThanBestDirect</h3>

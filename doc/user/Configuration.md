...
Here is an example including variable substitution, assuming version 2.9.0 of OTP:
...
| `HttpResponseTimeMetrics`             | Record HTTP response time metrics per client. Requires ActuatorAPI to be enabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |                    |    ✓️   |

...
otp.locale.Polish = {
    ...
    config :
    {
        ...
        datepicker_locale_short: "pl" //Doesn't use localization
    ...
    infoWidgets : [
            {
                title: 'Informacje',
                content: '<p>Informacje dotyczące strony</p>',
                //cssClass: 'otp-contactWidget',
            },
            {
                title: 'Kontakt',
                content: '<p>Sugestie? Skontaktuj się z nami...</p>'
            },
    ],
    ...
    time:
    {
        format         : "DD.MMM.YYYY, h:mm", //moment.js

...
public final class AccessEgressPreferences implements Serializable {
  ...
  private static TimeAndCostPenaltyForEnum<StreetMode> createDefaultAccessEgressPenalty() {
    ...
    // A flat penalty: the cost is independent of the ride duration, so it works as a fixed threshold
    // below which walking to the stop is preferred over a short carpool ride.
    var carpoolDefaultPenalty = TimeAndCostPenalty.of(TimePenalty.of(ofMinutes(10), 0f), 4.0);

...
/**
 * Relax a value by the given ratio and slack. The relaxed value can be calculated using this
 * function:
 * <pre>
 *   f(x) = ratio * x + slack
 * </pre>
...
public record Relax(double ratio, int slack) {
   ...
   * <p>
   * The relax operation should be skipped to save resources in this case, but it is safe to do
   * it.
   */

...
/**
 * This class stores input for the PageCursor. The input is related to the NumItinerariesFilter and
 ...
 * keep and whether it should crop at the head or the tail of the list. This class keeps the extreme
 * endpoints of the sets of itineraries that were kept and removed, as well as more details about
 * the first itinerary removed (bottom of the head, or top of the tail) and whether itineraries were
 * cropped at the head or the tail.
 * <p>
 * The
 * {@link org.opentripplanner.routing.algorithm.filterchain.filters.transit.RemoveTransitIfStreetOnlyIsBetter}
 * filter removes transit itineraries if the best street only itinerary has a lower cost. This class
 * stores the cost of the best street only itinerary for use with paging.
 */

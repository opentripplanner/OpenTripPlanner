 ...
 * keep and whether it should crop at the head or the tail of the list. The results class keeps the
 * extreme endpoints of the sets of itineraries that were kept and removed, as well as more details
 * about the first itinerary removed (bottom of the head, or top of the tail) and whether

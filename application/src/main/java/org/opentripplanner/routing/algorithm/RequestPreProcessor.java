 ...
 * {@link RoutingWorker}. This includes extending the request with a page cursor and amending its
 * data with additional resolved data, such as additional search days.
 */
public final class RequestPreProcessor {
   ...
   * {@link TripLocationResolver#resolve}). This produces exactly one Raptor iteration at the
   * boarding time while keeping a valid search window for the filter chain.
   */

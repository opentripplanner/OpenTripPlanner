...
public final class RoutingWorkerRequest {
   ...
   * stored relative to the {@link java.time.LocalDate}, but to be able to compare trip times for
   * different service days we normalize all times by calculating an offset. Now all times for the
   * selected trip patterns become relative to the {@code

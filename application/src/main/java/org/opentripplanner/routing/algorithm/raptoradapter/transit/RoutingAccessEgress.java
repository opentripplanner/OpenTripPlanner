 ...
 * {@link RaptorAccessEgress} with methods relevant only to street routing and access/egress
 * filtering.
 */
public interface RoutingAccessEgress extends RaptorAccessEgress {
  ...
  /**
   * Return the final state of the A* street search that reached the transit stop. "Final" refers to
   * the search order, not chronological order — for egress searches

...
filter-chain roles(`ItineraryDecorator`, `ItineraryListFilter`, `RemoveItineraryFlagger`) is a good
way to avoid dependencies from the itinerary-filter-chain to the sandbox module.

...
/**
 * This interface adds two methods to the {@link RaptorTimeTable} to optimize the trip search inside
 * the transit model. They were previously in Raptor, but the trip Search is moded outside of
 * Raptor; We have keep these methods in an interface to be able to reuse the complex TripSearch in
 * tests, which do not use the transit model {@link TripSchedule}; Hence also the generic type on
 * this interface.
 */

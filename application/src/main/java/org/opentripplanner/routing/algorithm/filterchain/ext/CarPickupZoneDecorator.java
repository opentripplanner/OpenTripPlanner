...
/**
 * This qualifier is used to tag the {@code CarPickupZoneItineraryDecorator}. The tag is used both
 ...
 * logical dependency on the car pickup zone provider at all.
 */
@Qualifier
@Documented
@Retention(RUNTIME)
public @interface CarPickupZoneDecorator {}

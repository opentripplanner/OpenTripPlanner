...
public enum AlternativeLegsFilter {
  ...
  SAME_AGENCY(
    (Leg leg) -> (TripPattern tripPattern) -> leg.agency()
      .equals(tripPattern.getRoute().getAgency())
  ),
  ...
  SAME_SUBMODE(
    (Leg leg) -> (TripPattern tripPattern) -> leg.trip()
      .getNetexSubMode()
      .equals(tripPattern.getNetexSubmode())
  );

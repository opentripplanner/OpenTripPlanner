 ...
 * for the lifetime of that request — most importantly the {@link TransactionScope} pinning a
 * consistent view of real-time data, and anything derived from it (e.g.

...
public class VehicleParkingConfig {
  ...
  static void mapParking(NodeAdapter c, VehicleParkingPreferences.Builder preferences) {
    var vehicleParking = c.of("parking")
      .since(V2_5)
  ...
  private static void mapParkingPreferences(
    ...
    builder.withUnpreferredVehicleParkingTagCost(
      c.of("unpreferredVehicleParkingTagCost")
        .since(V2_3)
      ...
      .withRequiredVehicleParkingTags(
        c.of("requiredVehicleParkingTags")
          .since(V2_1)
          .summary(
      ...
      .withPreferredVehicleParkingTags(
        c.of("preferredVehicleParkingTags")
          .since(V2_3)
          .summary(

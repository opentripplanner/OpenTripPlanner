...
public class WheelchairConfig {
  ...
  public static void mapWheelchairPreferences(
    ...
    builder.withTrip(
      it -> mapAccessibilityPreferences(
        a.of("trip")
          .since(V2_2)
      ...
      .withInaccessibleStreetReluctance(
        a.of("inaccessibleStreetReluctance")
          .since(V2_2)
          .summary(
  ...
  static void mapAccessibilityPreferences(
    ...
    var onlyConsiderAccessible = adapter.of("onlyConsiderAccessible")
      .since(V2_2)
      .summary(

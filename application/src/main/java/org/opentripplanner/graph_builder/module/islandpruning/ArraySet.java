 ...
 * neighbor lists in {@link IslandPruningModule} (a handful of elements each), the hashing
 * overhead of a hash-based {@code Set} costs more than a linear scan saves. Benchmarked against a
 * full-country OSM extract, a {@code HashSet}-based dedupe of those neighbor lists was ~14%
 * slower overall than this approach.
 * <p>

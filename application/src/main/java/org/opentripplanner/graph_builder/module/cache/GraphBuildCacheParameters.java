...
/**
 * Runtime parameters for the graph-build cache, derived from {@code build-config.json}. Kept in the
 * cache package so that {@link GraphBuildCacheManager} and related classes have no dependency on

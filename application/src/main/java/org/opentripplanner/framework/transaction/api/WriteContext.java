 ...
 *
 * <p>
 * A {@code WriteContext} is created fresh for each task submitted to the {@link UpdateManager}
 ...
 *
 * <p>
 * Code outside a submitted task cannot obtain a {@code WriteContext}, making the write path
...
public interface WriteContext {
   ...
   *
   * <p>
   * Handlers that need to write to a repository receive the mutable repository via their

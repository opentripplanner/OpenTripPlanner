 ...
 *
 * <p>
 * A lifecycle is registered once per repository. The framework calls
...
public interface RepositoryLifecycle<S, M> {
   ...
   *
   * <p>
   * Called when a transaction commits. After this call the repository is discarded; the returned
   * repository snapshot becomes the visible state for the next transaction.
   */

 ...
 * <p>
 * This interface provide an abstraction layer for accessing OTP data input and output sources.
 * It is an abstraction for reading from and/or writing to files whenever the file is located on the
 ...
 * <p>
 * The {@link org.opentripplanner.datastore.OtpDataStore} will manage all repositories so there
 * is no need to use the repository directly.
 */

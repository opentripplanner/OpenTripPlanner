...
public class GtfsFeedIdResolver {
   ...
   * <p>
   * This will try to fetch the experimental feed_id field from the feed_info.txt file.</p>
   * <p>
   ...
   * not exist already. The single access point(this method) guarantee thread-safety.</p>
   *

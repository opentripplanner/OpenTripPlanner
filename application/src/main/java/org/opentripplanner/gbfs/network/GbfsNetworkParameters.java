 ...
 *
 * @param geofencingZonePhase which OTP phase computes and applies this network's geofencing zones.
 *   Configured as {@code applyGeofencingZones}.
 ...
 *   Has no effect when {@code geofencingZonePhase} is {@link GeofencingZoneOtpPhase#OFF}.

...
/**
 * The responsibility of this service is to provide information from Open Street Map, which is NOT
 * in the OTP street graph. The graph build happens in phases, and some data is read in from the OSM
 * files, but needed later on. For example, we might need info from OSM to link street

    ...
    return (GraphQLObjectType.newObject()
        ...
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .dataFetcher(
            environment -> GraphQLUtils.getTranslation(
              ((Place) environment.getSource()).name,
              environment
            )
          )
          .build()
      ...
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .type(quayType)
          .dataFetcher(
            environment -> ((Place) environment.getSource()).stop instanceof RegularStop
      ...
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .dataFetcher(
            environment -> ((Place) environment.getSource()).stop instanceof AreaStop
      ...
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .dataFetcher(
            environment -> ((Place) environment.getSource()).vertexType.equals(

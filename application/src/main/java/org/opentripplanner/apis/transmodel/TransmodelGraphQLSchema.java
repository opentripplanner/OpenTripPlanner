      ...
      .field(
        GraphQLFieldDefinition
          ...
          .dataFetcher(environment -> {
            return GqlUtil
              .getTransitService(environment)
              .getAgencyForId(mapIDToDomain(environment.getArgument("id")));
          })
          .build()
      )
      .field(
      ...
      .field(
        GraphQLFieldDefinition
          ...
          .dataFetcher(environment ->
            GqlUtil
              .getTransitService(environment)
              .getOperatorForId(mapIDToDomain(environment.getArgument("id")))
          )
          .build()
      )
      .field(
      ...
      .field(
        GraphQLFieldDefinition
          ...
          .dataFetcher(environment -> {
            ...
            return GqlUtil.getTransitService(environment).getRouteForId(mapIDToDomain(id));
          })
          .build()
      )
      .field(
      ...
      .field(
        GraphQLFieldDefinition
          ...
          .dataFetcher(environment ->
            GqlUtil
              .getTransitService(environment)
              .getGroupOfRoutesForId(mapIDToDomain(environment.getArgument("id")))
          )
          .build()
      )
      .field(
      ...
      .field(
        GraphQLFieldDefinition
          ...
          .dataFetcher(environment -> {
            return GqlUtil
              .getTransitService(environment)
              .getTripForId(mapIDToDomain(environment.getArgument("id")));
          })
          .build()
      )
      .field(

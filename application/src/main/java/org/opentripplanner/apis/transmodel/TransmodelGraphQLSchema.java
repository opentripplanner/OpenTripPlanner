 ...
 * injectable binding. A bare {@code GraphQLSchema} is ambiguous for that purpose since the GTFS API
 * binds one too, and JAX-RS {@code @Context} resolves by type only, not by Dagger qualifier.
 */

    ...
    return GraphQLObjectType.newObject()
      ...
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .deprecate(
            "Use realTimeJourneyState on datedServiceJourney for the journey's real-time state, or the individual boolean fields (cancellation, predictionInaccurate, extraCall) for the stop's state."
          )

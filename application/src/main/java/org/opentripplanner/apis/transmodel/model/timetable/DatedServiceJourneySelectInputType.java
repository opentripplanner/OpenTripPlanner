...
class DatedServiceJourneySelectInputType {

  static final GraphQLInputObjectType INPUT_TYPE = GraphQLInputObjectType.newInputObject()
    .name("DatedServiceJourneySelectInput")
    .description(
      "A selector for filter allow-list / exclude-list. " +
        "At least one field must be provided. " +
        "A dated service journey matches a selector if it matches all fields. " +
        "Within each field, a journey matches if it matches any of the listed values."
    )
    .field(
      GraphQLInputObjectField.newInputObjectField()
        ...
        .description(
          "Set of ids for lines that should be included in/excluded from search. " +
            "A journey matches if its line matches any of the given IDs. " +
      ...
      GraphQLInputObjectField.newInputObjectField()
        ...
        .description(
          "Set of ids for authorities that should be included in/excluded from search. " +
            "A journey matches if its authority matches any of the given IDs. " +
    ...
    .field(
      GraphQLInputObjectField.newInputObjectField()
        .name("transportModes")
        .description(
          "The allowed modes for the dated service journey. " +
            "A journey matches if its mode matches any of the listed modes. " +

    ...
    return (GraphQLObjectType.newObject()
      ...
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .dataFetcher(
            environment -> RelativeDirectionMapper.map(
              ((WalkStep) environment.getSource()).getRelativeDirection()
            )
          )
          .build()
      )
      ...
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .dataFetcher(
            environment -> ((WalkStep) environment.getSource()).getAbsoluteDirection().orElse(null)
          )
          .build()
      )
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .type(Scalars.GraphQLString)
          .dataFetcher(
            environment -> ((WalkStep) environment.getSource()).highwayExit().orElse(null)
          )
          .build()
      )
      .field(
      ...
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .type(Scalars.GraphQLFloat)
          .dataFetcher(
            environment -> ((WalkStep) environment.getSource()).getStartLocation().latitude()
          )
          .build()
      )
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .type(Scalars.GraphQLFloat)
          .dataFetcher(
            environment -> ((WalkStep) environment.getSource()).getStartLocation().longitude()
          )
          .build()
      )
      .field(
        GraphQLFieldDefinition.newFieldDefinition()
          ...
          .dataFetcher(
            environment -> ElevationProfileStepType.mapElevationProfile(

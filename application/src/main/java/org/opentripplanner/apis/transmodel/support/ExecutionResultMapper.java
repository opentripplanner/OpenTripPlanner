...
public class ExecutionResultMapper {
  ...
  private static final ErrorClassification API_PROCESSING_TIMEOUT = ErrorClassification
    .errorClassification("ApiProcessingTimeout");

  private static final ErrorClassification RESPONSE_TOO_LARGE = ErrorClassification
    .errorClassification("ResponseTooLarge");

  private static final ErrorClassification BAD_REQUEST_ERROR = ErrorClassification
    .errorClassification("BadRequestError");

  private static final ErrorClassification INTERNAL_SERVER_ERROR = ErrorClassification
    .errorClassification("InternalServerError");

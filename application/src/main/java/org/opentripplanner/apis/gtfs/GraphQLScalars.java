...
public class GraphQLScalars {
  ...
  public static final GraphQLScalarType DURATION_SCALAR = DurationScalarFactory
    .createDurationScalar();
  ...
  public static final GraphQLScalarType COST_SCALAR = GraphQLScalarType.newScalar()
    .name("Cost")
    .coercing(new Coercing<Cost, Integer>() {
  ...
  public static final GraphQLScalarType LOCAL_DATE_SCALAR = DateScalarFactory
    .createGtfsDateScalar();
  ...
  public static final GraphQLScalarType GRAMS_SCALAR = GraphQLScalarType.newScalar()
    .name("Grams")
    .coercing(new Coercing<Gram, Double>() {
      @Override
      public Double serialize(Object dataFetcherResult) throws CoercingSerializeException {

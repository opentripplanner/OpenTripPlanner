...
public class GraphQLTypes {
  ...
  public static class GraphQLBicycleParkingPreferencesInput {
    ...
    private org.opentripplanner.core.domain.model.basic.Cost unpreferredCost;
    ...
    public GraphQLBicycleParkingPreferencesInput(Map<String, Object> args) {
      if (args != null) {
        ...
        this.unpreferredCost = (org.opentripplanner.core.domain.model.basic.Cost) args.get(
          "unpreferredCost"
        );
      }
    }
    ...
    public org.opentripplanner.core.domain.model.basic.Cost getGraphQLUnpreferredCost() {
    ...
    public void setGraphQLUnpreferredCost(
      org.opentripplanner.core.domain.model.basic.Cost unpreferredCost
    ) {
  ...
  public static class GraphQLBicyclePreferencesInput {
    ...
    private org.opentripplanner.core.domain.model.basic.Cost boardCost;
    ...
    public GraphQLBicyclePreferencesInput(Map<String, Object> args) {
      if (args != null) {
        this.boardCost = (org.opentripplanner.core.domain.model.basic.Cost) args.get("boardCost");
    ...
    public org.opentripplanner.core.domain.model.basic.Cost getGraphQLBoardCost() {
    ...
    public void setGraphQLBoardCost(org.opentripplanner.core.domain.model.basic.Cost boardCost) {
  ...
  public static class GraphQLBicycleWalkPreferencesCostInput {
    ...
    private org.opentripplanner.core.domain.model.basic.Cost mountDismountCost;
    private Double reluctance;

    public GraphQLBicycleWalkPreferencesCostInput(Map<String, Object> args) {
      if (args != null) {
        this.mountDismountCost = (org.opentripplanner.core.domain.model.basic.Cost) args.get(
          "mountDismountCost"
        );
        this.reluctance = (Double) args.get("reluctance");
      }
    ...
    public org.opentripplanner.core.domain.model.basic.Cost getGraphQLMountDismountCost() {
    ...
    public void setGraphQLMountDismountCost(
      org.opentripplanner.core.domain.model.basic.Cost mountDismountCost
    ) {
  ...
  public static class GraphQLDestinationBicyclePolicyInput {
    ...
    private org.opentripplanner.core.domain.model.basic.Cost keepingCost;

    public GraphQLDestinationBicyclePolicyInput(Map<String, Object> args) {
      if (args != null) {
        this.allowKeeping = (Boolean) args.get("allowKeeping");
        this.keepingCost = (org.opentripplanner.core.domain.model.basic.Cost) args.get(
          "keepingCost"
        );
      }
    }
    ...
    public org.opentripplanner.core.domain.model.basic.Cost getGraphQLKeepingCost() {
    ...
    public void setGraphQLKeepingCost(
      org.opentripplanner.core.domain.model.basic.Cost keepingCost
    ) {
  ...
  public static class GraphQLLinearCostFunctionInput {
    ...
    private org.opentripplanner.core.domain.model.basic.Cost constant;

    public GraphQLLinearCostFunctionInput(Map<String, Object> args) {
      if (args != null) {
        this.coefficient = (Double) args.get("coefficient");
        this.constant = (org.opentripplanner.core.domain.model.basic.Cost) args.get("constant");
      }
    }
    ...
    public org.opentripplanner.core.domain.model.basic.Cost getGraphQLConstant() {
    ...
    public void setGraphQLConstant(org.opentripplanner.core.domain.model.basic.Cost constant) {
  ...
  public static class GraphQLTransferPreferencesInput {
    ...
    private org.opentripplanner.core.domain.model.basic.Cost cost;
    ...
    public GraphQLTransferPreferencesInput(Map<String, Object> args) {
      if (args != null) {
        this.cost = (org.opentripplanner.core.domain.model.basic.Cost) args.get("cost");
    ...
    public org.opentripplanner.core.domain.model.basic.Cost getGraphQLCost() {
      return this.cost;
    }
    ...
    public void setGraphQLCost(org.opentripplanner.core.domain.model.basic.Cost cost) {
      this.cost = cost;
    }

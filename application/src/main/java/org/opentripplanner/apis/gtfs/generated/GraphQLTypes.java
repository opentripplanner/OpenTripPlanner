    ...
    public GraphQLBicycleParkingPreferencesInput(Map<String, Object> args) {
      if (args != null) {
        if (args.get("filters") != null) {
          this.filters = new ArrayList<GraphQLParkingFilterInput>();
          for (var o : (List<Map<String, Object>>) args.get("filters")) {
            if (o != null) {
              this.filters.add(new GraphQLParkingFilterInput(o));
            } else {
        ...
        if (args.get("preferred") != null) {
          this.preferred = new ArrayList<GraphQLParkingFilterInput>();
          for (var o : (List<Map<String, Object>>) args.get("preferred")) {
            if (o != null) {
              this.preferred.add(new GraphQLParkingFilterInput(o));
            } else {
              this.preferred.add(null);
            }
          }
        }
    ...
    public GraphQLParkingFilterInput(Map<String, Object> args) {
      if (args != null) {
        if (args.get("not") != null) {
          this.not = new ArrayList<GraphQLParkingFilterOperationInput>();
          for (var o : (List<Map<String, Object>>) args.get("not")) {
            if (o != null) {
              this.not.add(new GraphQLParkingFilterOperationInput(o));
            } else {
              this.not.add(null);
            }
          }
        ...
        if (args.get("select") != null) {
          this.select = new ArrayList<GraphQLParkingFilterOperationInput>();
          for (var o : (List<Map<String, Object>>) args.get("select")) {
            if (o != null) {
              this.select.add(new GraphQLParkingFilterOperationInput(o));
            } else {
    ...
    public GraphQLPlanTransitModesInput(Map<String, Object> args) {
      if (args != null) {
        ...
        if (args.get("transit") != null) {
          this.transit = new ArrayList<GraphQLPlanTransitModePreferenceInput>();
          for (var o : (List<Map<String, Object>>) args.get("transit")) {
            if (o != null) {
              this.transit.add(new GraphQLPlanTransitModePreferenceInput(o));
            } else {
              this.transit.add(null);
            }
          }
        }
      }
    ...
    public GraphQLQueryTypePlanArgs(Map<String, Object> args) {
      if (args != null) {
        ...
        if (args.get("intermediatePlaces") != null) {
          this.intermediatePlaces = new ArrayList<GraphQLInputCoordinatesInput>();
          for (var o : (List<Map<String, Object>>) args.get("intermediatePlaces")) {
            if (o != null) {
              this.intermediatePlaces.add(new GraphQLInputCoordinatesInput(o));
            } else {
              this.intermediatePlaces.add(null);
            }
          }
        }
        ...
        if (args.get("transportModes") != null) {
          this.transportModes = new ArrayList<GraphQLTransportModeInput>();
          for (var o : (List<Map<String, Object>>) args.get("transportModes")) {
            if (o != null) {
              this.transportModes.add(new GraphQLTransportModeInput(o));
            } else {
              this.transportModes.add(null);
            }
          }
        }
        ...
        if (args.get("via") != null) {
          this.via = new ArrayList<GraphQLPlanViaLocationInput>();
          for (var o : (List<Map<String, Object>>) args.get("via")) {
            if (o != null) {
              this.via.add(new GraphQLPlanViaLocationInput(o));
            } else {
              this.via.add(null);
            }
          }

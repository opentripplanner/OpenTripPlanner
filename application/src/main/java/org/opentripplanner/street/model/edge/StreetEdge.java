...
public class StreetEdge
  ...
  private TraversalCosts otherTraversalCosts(
    ...
    var weight = time * computeReluctance(request, traverseMode, walkingBike, isStairs());
  ...
  private TraversalCosts bicycleOrScooterTraversalCost(
    ...
    switch (optimizeType) {
      // we exaggerate the safety for this preference
  ...
  private TraversalCosts walkingTraversalCosts(
    ...
    if (wheelchair) {
      ...
      weight *= computeReluctance(request, traverseMode, walkingBike, isStairs());
    }

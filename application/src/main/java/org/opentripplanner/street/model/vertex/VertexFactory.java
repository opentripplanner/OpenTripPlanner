...
public class VertexFactory {
  ...
  public StationEntranceVertex stationEntrance(long nid, Coordinate coordinate, String code) {
    return addToGraph(new StationEntranceVertex(coordinate.x, coordinate.y, nid, code));
  }

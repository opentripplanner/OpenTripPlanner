...
/**
 * Interface for a blocking, polling approach to retrieving SIRI realtime timetable updates. TODO
 * RT_AB: Clearly document whether the methods should return as fast as possible, or if they should
 * intentionally block and wait for refreshed data, and how this fits into the design.
 */
public interface EstimatedTimetableSource {
  ...
  /**
   * @return The incrementality of the last collection of updates. {@link UpdateIncrementality}
   */

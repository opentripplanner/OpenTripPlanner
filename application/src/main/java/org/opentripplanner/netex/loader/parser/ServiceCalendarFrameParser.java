...
class ServiceCalendarFrameParser extends NetexParser<ServiceCalendarFrame_VersionFrameStructure> {
  ...
  private final Multimap<String, DayTypeAssignment> dayTypeAssignmentByDayTypeId = ArrayListMultimap
    .create();
  ...
  private void parseOperatingPeriods(OperatingPeriodsInFrame_RelStructure operatingPeriods) {
    ...
    for (
      OperatingPeriod_VersionStructure p : operatingPeriods.getOperatingPeriodOrUicOperatingPeriod()
    ) {

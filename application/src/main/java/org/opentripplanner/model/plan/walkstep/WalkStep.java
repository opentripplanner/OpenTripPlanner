...
public final class WalkStep {
  ...
  /**
   * A piece of information that {@link WalkStep#getRelativeDirection()} relates to. This could be
   * the name of the street ("turn right at Main Street") but also a station entrance ("enter
   * station at Entrance 4B") or what is on a sign ("follow signs for Platform 9").
   */

 ...
 * {@link org.opentripplanner.routing.algorithm.filterchain.framework.filter.SortingFilter} as
 * defined by the
 * {@link org.opentripplanner.routing.algorithm.filterchain.framework.sort.SortOrderComparator}.
 * <p>
 * The methods in this interface are NOT documented here, but in the Itinerary class. To keep it
 * simple, this interface should be kept in sync with method names in the itinerary.
 */
public interface ItinerarySortKey {
  Instant startTimeAsInstant();
  Instant endTimeAsInstant();
  NormalizedCost generalizedCostIncludingPenalty();

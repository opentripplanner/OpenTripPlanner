...
class TransitGroupPriority32n {
  ...
  /**
   * Left dominates right: - if right contains a group which does not exist in the left. Left do NOT
   * dominate right: - if they are equals or - left is a superset of right.
   */

 ...
 * for the duration of the request, but new requests get the current Timetable Snapshot.
 * <p>
 * Shared by the GTFS and Transmodel query APIs, which have different names but the same
 * concepts (Route/Line, Trip/ServiceJourney, TripOnServiceDate/DatedServiceJourney).
 */

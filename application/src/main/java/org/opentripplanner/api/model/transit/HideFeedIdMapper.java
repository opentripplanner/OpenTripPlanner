...
/**
 * An id mapper that appends a configured feed id to all input ids and strips the feed id from all
 * output ids. This only works if your deployment only contains a single feed id.
 */

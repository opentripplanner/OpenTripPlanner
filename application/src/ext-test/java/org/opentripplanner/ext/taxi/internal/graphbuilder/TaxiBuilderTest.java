...
class TaxiBuilderTest {
  ...
  private static void assertSingleTaxiTripSkippedIssue(
    ...
    assertThat(issue).isInstanceOf(TaxiTripSkipped.class);
    var skipped = (TaxiTripSkipped) issue;

...
class FlexibleTransitLegTest implements PlanTestConstants {
  ...
  void copyOf() {
    var leg = new FlexibleTransitLegBuilder()
      ...
      .withEndTime(END_TIME)
      .withFlexTripEdge(EDGE)
      .withFareProducts(List.of(ANY_FARE_PRODUCT_USE))
    ...
    assertEquals(List.of(ANY_FARE_PRODUCT_USE), copy.fareProducts());
  ...
  void timeShift() {
    ...
    assertEquals(List.of(ANY_FARE_PRODUCT_USE), shifted.fareProducts());

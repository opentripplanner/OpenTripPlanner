...
class FlexibleTransitLegBuilderTest implements PlanTestConstants {
  ...
  private static final ZonedDateTime START_TIME = ZonedDateTime.parse(
  ...
  void listsAreInitialized(){
    var leg = new FlexibleTransitLegBuilder().withStartTime(START_TIME).withEndTime(END_TIME).withFlexTripEdge(EDGE).build();
  ...
  @Test
  void copy(){
    var leg = new FlexibleTransitLegBuilder().withStartTime(START_TIME).withEndTime(END_TIME).withFlexTripEdge(EDGE)
  ...
  @Test
  void timeShift(){
    var leg = new FlexibleTransitLegBuilder().withStartTime(START_TIME).withEndTime(END_TIME).withFlexTripEdge(EDGE).withFareProducts(List.of(FARE_PRODUCT_USE)).withAlerts(Set.of(ALERT)).build();

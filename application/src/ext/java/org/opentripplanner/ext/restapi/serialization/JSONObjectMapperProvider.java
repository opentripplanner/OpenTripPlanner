...
public class JSONObjectMapperProvider implements ContextResolver<ObjectMapper> {
  ...
  /**
   * Pre-instantiate a Jackson ObjectMapper that will be handed off to all incoming Jersey requests,
   * and used to construct the ObjectWriters that will produce JSON responses.
   */

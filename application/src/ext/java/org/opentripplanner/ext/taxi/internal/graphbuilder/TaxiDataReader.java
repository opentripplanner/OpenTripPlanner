...
public class TaxiDataReader {
  ...
  private static final Logger LOG = LoggerFactory.getLogger(TaxiDataReader.class);

  private final TaxiRepository taxiRepository;
  private final DataImportIssueStore issueStore;

  public TaxiDataReader(TaxiRepository taxiRepository, DataImportIssueStore issueStore) {

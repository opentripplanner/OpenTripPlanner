 ...
 * <p>
 * Contains all information needed to construct an itinerary, including: - The original trip -
 * Insertion positions (where pickup and dropoff occur in the modified route) - Route segments (all
 * GraphPaths forming the complete modified route) - Timing information
 * <p>
...
public record InsertionCandidate(
  ...
  /**
   * Gets the pickup route segment(s) - from boarding to passenger pickup. Returns all segments
   * before the pickup position.
   */
  ...
  /**
   * Gets the shared route segment(s) - from passenger pickup to dropoff. Returns all segments
  ...
  /**
   * Gets the dropoff route segment(s) - from passenger dropoff to alighting. Returns all segments
   * after the dropoff position.
   */
   ...
   * {@link #getPassengerRideDuration()}. Returns {@link Duration#ZERO} when the passenger boards at
   * the trip origin (no pickup segments).
   */

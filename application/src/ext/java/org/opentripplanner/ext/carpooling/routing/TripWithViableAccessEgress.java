...
/**
 * Associates a {@link CarpoolTripWithVertices} with the list of {@link ViableAccessEgress} entries
 * that passed heuristic filtering for that trip. Each viable access/egress represents a transit
 * stop that can potentially be served by this carpool trip.
 *

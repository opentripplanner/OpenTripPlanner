...
/**
 * A {@link RoutedSegment} over a path that already exists — the result of a goal-directed search,
 * or a path built in a test. Its duration and endpoints are read off the path.
 */

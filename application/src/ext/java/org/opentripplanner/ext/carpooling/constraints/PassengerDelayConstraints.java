...
/**
 * Validates that inserting a new passenger does not cause excessive delays for existing stops in a
 * carpool trip.
 * <p>
 ...
 * <p>
 * This protects the rider experience by preventing situations where accepting one more passenger
 * significantly inconveniences existing bookings.
 */
public final class PassengerDelayConstraints {
  ...
  /**
   * Checks if a passenger insertion satisfies delay constraints for all existing stops. Each stop
   * is checked against its own deviation budget.
   *
   ...
   * @param pickupPos                   0-based index of the passenger's pickup in the modified
   *                                    route
   * @param dropoffPos                  0-based index of the passenger's dropoff in the modified
   *                                    route

...
public class FaresConfiguration {
  ...
  public static NodeAdapter fromConfig(NodeAdapter root, String parameterName) {
    ...
    // Fares.md.
    return root.of(parameterName).summary("Fare configuration.").since(OtpVersion.V2_0).asObject();
  }

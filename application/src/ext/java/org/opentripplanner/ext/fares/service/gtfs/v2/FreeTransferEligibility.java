...
/// default implementation ([FareLookupService#DEFAULT_FREE_TRANSFER_MATCH_PREDICATE]) matches on
/// equal rider category and fare medium.
///
/// @see <a href="https://github.com/google/transit/pull/423">GTFS spec discussion</a>
@FunctionalInterface
public interface FreeTransferEligibility {
  /// Returns `true` if the free transfer described by `transfer` applies to `product`.

 ...
 */
class InvalidNewStopSequenceTest implements RealtimeTestConstants {
    ...
    var update = rt
      ...
      .addRawStopTime(
        StopTimeUpdate.newBuilder()
          .setStopId(STOP_A_ID)
          .setStopSequence(-1)
          .setDeparture(StopTimeEvent.newBuilder().setTime(1000))
          .build()
      )
      .build();
    ...
    var update = rt
      ...
      .addRawStopTime(
        StopTimeUpdate.newBuilder()
          .setStopId(STOP_A_ID)
          .setStopSequence(9)
          .setDeparture(StopTimeEvent.newBuilder().setTime(1060))
          .build()
      )
      .build();

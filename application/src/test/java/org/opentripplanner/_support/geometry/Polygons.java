...
public class Polygons {
  ...
  public static final Polygon BERLIN = FAC.createPolygon(new Coordinate[] {
  ...
  public static final Polygon OSLO = FAC.createPolygon(new Coordinate[] {
  ...
  public static final Polygon OSLO_FROGNER_PARK = FAC.createPolygon(new Coordinate[] {
  ...
  public static final Polygon SELF_INTERSECTING = FAC.createPolygon(new Coordinate[] {
    Coordinates.of(1, 1),
    Coordinates.of(1, 2),
    Coordinates.of(1, 3),
    Coordinates.of(1, 1),

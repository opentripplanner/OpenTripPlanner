...
import static org.opentripplanner.OtpArchitectureModules.CORE_DOMAIN_FRAMEWORK;
import static org.opentripplanner.OtpArchitectureModules.CORE_DOMAIN_MODEL;
...
public class FrameworkArchitectureTest {
  ...
  private static final Package I18N = CORE_DOMAIN_MODEL.subPackage("i18n");
  private static final Package IO = FRAMEWORK.subPackage("io");
  private static final Package LOGGING = FRAMEWORK.subPackage("logging");
  private static final Package RESOURCES = CORE_DOMAIN_FRAMEWORK.subPackage("resources");

...
public class RemoveBikeRentalWithMostlyWalkingTest {
  ...
  public void filter() {
    ...
    Itinerary t1 = newItinerary(A).bicycle(T10_10, T10_20, B).walk(D5_m, E).build();
    Itinerary t2 = newItinerary(A).rentedBicycle(T10_10, T10_20, B).walk(D5_m, E).build();
    Itinerary t3 = newItinerary(A).rentedBicycle(T10_10, T10_20, B).walk(D3_h, E).build();

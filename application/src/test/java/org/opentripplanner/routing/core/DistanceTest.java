...
public class DistanceTest {
  ...
  private static final Distance TWO_KILOMETERS = Distance.ofKilometersBoxed(2d, ignore -> {})
    .orElse(null);
  private static final Distance ONE_HUNDRED_METERS = Distance.ofMetersBoxed(100d, ignore -> {})
    .orElse(null);
  private static final Distance POINT_ONE_KILOMETER = Distance.ofKilometersBoxed(0.1d, ignore -> {})
    .orElse(null);

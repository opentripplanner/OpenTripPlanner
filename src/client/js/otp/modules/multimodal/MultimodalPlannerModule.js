...
otp.modules.multimodal.MultimodalPlannerModule =
    ...
    activate : function() {
        ...
        modeSelector.addModeControl(new otp.widgets.tripoptions.MaxSlopeSelector(this.optionsWidget));
        modeSelector.addModeControl(new otp.widgets.tripoptions.SlopeFactorSelector(this.optionsWidget));

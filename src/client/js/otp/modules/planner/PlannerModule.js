...
otp.modules.planner.PlannerModule =
    ...
    */
    ...
    error_messages : {
        ...
        404 : _tr("No trip found. There may be no reachable transit service within the specified access distance, or your start or end point might not be safely accessible."),

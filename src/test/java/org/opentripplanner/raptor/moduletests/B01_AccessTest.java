...
public class B01_AccessTest implements RaptorTestConstants {
  ...
  static List<RaptorModuleTestCase> testCases() {
    ...
    return RaptorModuleTestCase
      ...
      .add(
        multiCriteria(),
        "Walk 7m 0:11 0:18 C₁840 ~ D 0s ~ BUS R1 0:18 0:25 7m C₁1020 ~ F 0s ~ Walk 1s 0:25 0:25:01 C₁2 [0:11 0:25:01 14m1s Tₓ0 C₁1862]",
        "Walk 4m 0:10 0:14 C₁480 ~ C 0s ~ BUS R1 0:14 0:25 11m C₁1260 ~ F 0s ~ Walk 1s 0:25 0:25:01 C₁2 [0:10 0:25:01 15m1s Tₓ0 C₁1742]",
        "Walk 1s 0:09:59 0:10 C₁2 ~ B 0s ~ BUS R1 0:10 0:25 15m C₁1500 ~ F 0s ~ Walk 1s 0:25 0:25:01 C₁2 [0:09:59 0:25:01 15m2s Tₓ0 C₁1504]"
      )
      .build();
  }

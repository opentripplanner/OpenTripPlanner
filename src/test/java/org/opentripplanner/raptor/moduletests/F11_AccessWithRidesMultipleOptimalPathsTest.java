...
public class F11_AccessWithRidesMultipleOptimalPathsTest implements RaptorTestConstants {
  ...
  static List<RaptorModuleTestCase> testCase3mWalkAccess() {
    ...
    var flexTransferTransit = startFlexAccess + endWalkAndL3 + "[0:02 0:22 20m Tₓ1 C₁2580]";
    // Best duration 18m,
    var transitAndTransit = startWalkAndL1 + endL2AndWalk + "[0:02 0:23 21m Tₓ1]";
    // Min-Duration 19m
    var flexAndTransit = startFlexAccess + endL2AndWalk + "[0:03 0:23 20m Tₓ1 C₁2640]";
  ...
  static List<RaptorModuleTestCase> testCase1mWalkAccess() {
    ...
    // Min-Duration 17m
    var flexAndTransit = startFlexAccess + endL2AndWalk + "[0:03 0:21 18m Tₓ1 C₁2400]";

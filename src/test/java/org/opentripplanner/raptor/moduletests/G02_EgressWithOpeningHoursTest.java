...
public class G02_EgressWithOpeningHoursTest implements RaptorTestConstants {
  ...
  private static List<RaptorModuleTestCase> openNoTimeRestrictionTestCase() {
    var expected = new ExpectedList(
      "A ~ BUS R1 0:10 0:20 ~ B ~ Walk 2m [0:10 0:22 12m Tₓ0 C₁1440]",
      "A ~ BUS R1 0:20 0:30 ~ B ~ Walk 2m [0:20 0:32 12m Tₓ0 C₁1440]",
      "A ~ BUS R1 0:30 0:40 ~ B ~ Walk 2m [0:30 0:42 12m Tₓ0 C₁1440]",
  ...
  private static List<RaptorModuleTestCase> openOneHourTestCase() {
    var expected = new ExpectedList(
      "A ~ BUS R1 0:10 0:20 ~ B ~ Walk 2m Open(0:00 1:00) [0:10 0:22 12m Tₓ0 C₁1440]",
      "A ~ BUS R1 0:20 0:30 ~ B ~ Walk 2m Open(0:00 1:00) [0:20 0:32 12m Tₓ0 C₁1440]",
      "A ~ BUS R1 0:30 0:40 ~ B ~ Walk 2m Open(0:00 1:00) [0:30 0:42 12m Tₓ0 C₁1440]",
      "A ~ BUS R1 0:20+1d 0:30+1d ~ B ~ Walk 2m Open(0:00 1:00) [0:20+1d 0:32+1d 12m Tₓ0 C₁1440]"
    );
  ...
  private static List<RaptorModuleTestCase> openInFirstHalfIntervalTestCase() {
    var expected = new ExpectedList(
      "A ~ BUS R1 0:10 0:20 ~ B ~ Walk 2m Open(0:00 0:25) [0:10 0:22 12m Tₓ0 C₁1440]",
  ...
  private static List<RaptorModuleTestCase> openInFirstHalfIntervalTestNextDayTestCase() {
    var expected =
      "A ~ BUS R1 0:20+1d 0:30+1d ~ B ~ Walk 2m Open(0:25 0:40) [0:20+1d 0:32+1d 12m Tₓ0 C₁1440]";
  ...
  private static List<RaptorModuleTestCase> partiallyOpenIntervalTestCase() {
    var expected = new ExpectedList(
      "A ~ BUS R1 0:10 0:20 ~ B ~ Walk 2m Open(0:25 0:35) [0:10 0:27 17m Tₓ0 C₁1740]",
      "A ~ BUS R1 0:20 0:30 ~ B ~ Walk 2m Open(0:25 0:35) [0:20 0:32 12m Tₓ0 C₁1440]",

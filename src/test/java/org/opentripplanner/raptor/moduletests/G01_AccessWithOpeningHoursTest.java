...
public class G01_AccessWithOpeningHoursTest implements RaptorTestConstants {
  ...
  private static List<RaptorModuleTestCase> openInSearchIntervalCases(String access) {
    var expected = new ExpectedList(
      access + EXP_00_15 + "[0:13 0:31 18m Tₓ0 C₁1860]",
      access + EXP_00_20 + "[0:18 0:36 18m Tₓ0 C₁1860]",
      access + EXP_00_25 + "[0:23 0:41 18m Tₓ0 C₁1860]",
      access + EXP_00_30 + "[0:28 0:46 18m Tₓ0 C₁1860]",
      access + EXP_24_15 + "[0:13+1d 0:31+1d 18m Tₓ0 C₁1860]",
      access + EXP_24_20 + "[0:18+1d 0:36+1d 18m Tₓ0 C₁1860]"
    );
  ...
  private static List<RaptorModuleTestCase> openInSecondHalfTodayTestCase() {
    ...
    var expected = new ExpectedList(
      ...
      access + EXP_24_20 + "[1:00 0:36+1d 23h36m Tₓ0 C₁0000]"
    );
  ...
  private static List<RaptorModuleTestCase> openInFirstHalfIntervalTestCase() {
    ...
    var expected = new ExpectedList(
      access + EXP_00_15 + "[0:13 0:31 18m Tₓ0 C₁1860]",
      access + EXP_00_20 + "[0:18 0:36 18m Tₓ0 C₁1860]",
      access + EXP_00_25 + "[0:20 0:41 21m Tₓ0 C₁2040]",
      access + EXP_00_30 + "[0:20 0:46 26m Tₓ0 C₁0000]",
      access + EXP_24_15 + "[0:13+1d 0:31+1d 18m Tₓ0 C₁1860]",
      access + EXP_24_20 + "[0:18+1d 0:36+1d 18m Tₓ0 C₁1860]"
    );
  ...
  private static List<RaptorModuleTestCase> partiallyOpenIntervalTestNextDayTestCase() {
    ...
    var expected = new ExpectedList(
      access + EXP_24_20 + "[0:18+1d 0:36+1d 18m Tₓ0 C₁1860]",
      access + EXP_24_25 + "[0:20+1d 0:41+1d 21m Tₓ0 C₁2040]"
    );

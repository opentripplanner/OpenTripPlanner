...
public class TranslationHelperTest {
        ...
        for (Stop stop : stops) {
            ...
            switch (id) {
                ...
                case "4":
                    ...
                    assertEquals(
                            "SV field value",
                            nameTranslation.toString(LOCALE_SV)
                    );
                    break;
                case "5":
    ...
    public final void testStopTimesTranslations() {
        ...
        for (StopTime stopTime : stopTimes) {
            String id = String.join("_", String.valueOf(stopTime.getId()),
            ...
            switch (id) {
                case "1_1":
                    ...
                    assertEquals(
                            "SV headsign rec 1 sub 1", headSignTranslation.toString(LOCALE_SV));
                    break;
                case "1_2":
                    assertEquals("Dest via 2", headSignTranslation.toString());
                    assertEquals("Dest via 2", headSignTranslation.toString(LOCALE_FEED));
                    assertEquals(
                            "SV headsign rec 1 sub 2", headSignTranslation.toString(LOCALE_SV));
                    break;
                case "3_1":
                case "4_1":
                    ...
                    assertEquals(
                            "SV headsign field value", headSignTranslation.toString(LOCALE_SV));
                    break;
            }
        }
    }

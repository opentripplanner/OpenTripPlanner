...
public class OptimizationTest extends GtfsTest {
    ...
    public void test2a1() {
        Itinerary itinerary = plan(
                +1388530860L, "2a1", "2a2", null, false,
                false,
                null, "", "", 1
        );
        ...
        assertEquals("Stop 2a1 ~ BUS short 0:01 0:02 ~ Stop 2a2 [ $90 ]", itinerary.toStr());
    }

    @Test
    public void test2a2() {
        Itinerary itinerary = plan(
                +1388530980L, "2a1", "2a2", null, false,
                false,
                null, "", "", 1
        );
        ...
        assertEquals("Stop 2a1 ~ BUS long 0:05 0:06 ~ Stop 2a2 [ $90 ]", itinerary.toStr());
    }
}

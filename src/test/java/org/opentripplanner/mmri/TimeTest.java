...
public class TimeTest extends GtfsTest {
    ...
    public void test1g1() {
        Itinerary itinerary = plan(
                +1388530920L, "1g1", "1g2", null, false,
                false,
                null, "", "", 1
        );
        ...
        assertEquals("Stop 1g1 ~ BUS bus 0:03 0:04 ~ Stop 1g2 [ $90 ]", itinerary.toStr());
    }

    @Test
    public void test1g2() {
        Itinerary itinerary = plan(
                -1388530980L, "1g1", "1g2", null, false,
                false,
                null, "", "", 1
        );
        ...
        assertEquals("Stop 1g1 ~ BUS bus 0:01 0:02 ~ Stop 1g2 [ $90 ]", itinerary.toStr());
    }
    ...
    public void test1g3() {
        Itinerary itinerary = plan(
                +1388617380L, "1g1", "1g2", null, false,
                false,
                null, "", "", 1
        );
    ...
    public void test1g4() {
        Itinerary itinerary = plan(
                -1388617440L, "1g1", "1g2", null, false,
                false,
                null, "", "", 1
        );
    ...
    public void test1g5() {
        Itinerary itinerary = plan(
                +1388703780L, "1g1", "1g2", null, false,
                false,
                null, "", "", 1
        );
    ...
    public void test1g6() {
        Itinerary itinerary = plan(
                -1388703840L, "1g1", "1g2", null, false,
                false,
                null, "", "", 1
        );

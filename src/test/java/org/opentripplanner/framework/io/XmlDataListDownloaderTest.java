...
public class XmlDataListDownloaderTest {
  ...
  public void testKML() {
    ...
    xmlDataListDownloader.setDataFactory(
      new XmlDataListDownloader.XmlDataFactory<>() {
        @Override
    ...
    List<DataTest> data = xmlDataListDownloader.download(
      "file:src/test/resources/xml/test-data.xml",
      false
    );

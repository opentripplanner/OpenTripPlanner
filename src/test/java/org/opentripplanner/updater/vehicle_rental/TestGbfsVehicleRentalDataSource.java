...
public class TestGbfsVehicleRentalDataSource extends TestCase {
    ...
    public void testParseVehiclesJson() {
        GbfsVehicleRentalDataSource gbfsVehicleRentalDataSource = new GbfsVehicleRentalDataSource(network);
        ...
        assertEquals(1, firstVehicle.vehiclesAvailable);
        assertEquals("TEST3", firstVehicle.id);
        assertEquals(true, firstVehicle.isFloatingVehicle);
        assertEquals("TEST3", firstVehicle.name.toString());
        assertEquals(true, firstVehicle.networks.contains(network));
        assertEquals(0, firstVehicle.spacesAvailable);
        assertEquals(-122.663295, firstVehicle.x);
        assertEquals(45.506149, firstVehicle.y);
    }
}

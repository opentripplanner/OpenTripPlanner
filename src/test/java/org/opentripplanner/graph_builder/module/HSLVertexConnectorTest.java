...
public class HSLVertexConnectorTest {
    private  HSLVertexConnector connector = new HSLVertexConnector();
	...
	@Test
	public void connectVertexWithoutHprefix() {
	...
	@Test
	public void doNotConnectVertex() {
	...
	@Test
	public void connectVertexWitHprefix() {
		when(ts.getStopCode()).thenReturn("321");
		boolean connected = connector.connectVertex(ts,false, vertices);
		assertTrue(connected);
	}
}
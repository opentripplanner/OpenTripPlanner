...
class MissingElevationHandlerTest {
    ...
    private StreetEdge edge(IntersectionVertex from, IntersectionVertex to, double length) {
        return new StreetEdge(from, to, null,
                new LocalizedStringFormat("%s%s", from.getName(), to.getName()), length,
    ...
    private void assertElevation(StreetEdge edge, double... points) {
        ...
        assertArrayEquals(expectedCoordinates.toArray(), edge.getElevationProfile().toCoordinateArray());
    }
}
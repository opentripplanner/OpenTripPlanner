...
import static org.opentripplanner.transit.raptor._data.api.PathUtils.pathsToStringDetailed;
...
public class D02_TimeDependentEgressTest implements RaptorTestConstants {
    ...
    public void openInWholeSearchIntervalTestFullDay() {
        requestBuilder.profile(RaptorProfile.MULTI_CRITERIA)
                .searchParams()
                .searchWindow(D25h)
                .addEgressPaths(walk(STOP_B, D2m, T00_00, T01_00));
    ...
    public void openInSecondHalfIntervalTestFullDay() {
        requestBuilder.profile(RaptorProfile.MULTI_CRITERIA)
                .searchParams()
                .searchWindow(D25h)
                .addEgressPaths(walk(STOP_B, D2m, T00_35, T01_00));
    ...
    public void openInSecondHalfIntervalTestNextDay() {
        requestBuilder.profile(RaptorProfile.MULTI_CRITERIA)
                .searchParams()
                .earliestDepartureTime(SECONDS_IN_DAY + T00_10)
                .addEgressPaths(walk(STOP_B, D2m, T00_25, T01_00));
    ...
    public void openInFirstHalfIntervalTest() {
        requestBuilder.profile(RaptorProfile.MULTI_CRITERIA)
                .searchParams()
                .addEgressPaths(walk(STOP_B, D2m, T00_00, T00_25));
    ...
    public void partiallyOpenIntervalTest() {
        requestBuilder.profile(RaptorProfile.MULTI_CRITERIA)
                .searchParams()
                .addEgressPaths(walk(STOP_B, D2m, T00_25, T00_35));

 ...
 */
public class D02_RouteWithNonBansChosenBannedStopsHardTest {
    ...
    private static final String EXPECTED_RESULT
            = "Walk 10s ~ 1 ~ BUS R2 0:02:30 0:04:40 ~ 3 ~ Walk 20s [00:01:50 00:05:10 3m20s]";
    ...
    public void setup() {
        ...
        data.add(
                route(pattern("R2",STOP_A,STOP_D, STOP_C))
                        .withTimetable(schedule().departures("00:02:30, 00:03:50, 00:04:50").arrDepOffset(D10s))
        );

 ...
 */
public class D04_ReboardPreviousIgnoredRouteWithBannedStopsHardTest {
  ...
  private static final String EXPECTED_RESULT
          ...
          + "BUS R2 0:04:41 0:05:01 ~ 4 ~ Walk 20s [00:00:55 00:05:31 4m36s]";
...
//     data.debugToStdErr(requestBuilder);
  ...
  public void multiCriteria() {
    ...
    assertEquals(
            EXPECTED_RESULT.replace("]", ", cost: 1566]"),
            pathsToString(response)
    );

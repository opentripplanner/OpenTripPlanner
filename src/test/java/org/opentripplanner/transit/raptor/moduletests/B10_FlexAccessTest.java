...
public class B10_FlexAccessTest implements RaptorTestConstants {
  ...
  public void multiCriteria() {
    ...
    assertEquals(""
            + "Flex 3m 2x ~ D ~ BUS R1 0:14 0:20 ~ F ~ Walk 1m [0:10 0:21 11m $1500.00]\n"  // ldt
            + "Flex 2m 2x ~ C ~ BUS R1 0:12 0:20 ~ F ~ Walk 1m [0:09 0:21 12m $1499.00]\n" // cost
            + "Flex 7m 1x ~ E ~ BUS R1 0:16 0:20 ~ F ~ Walk 1m [0:08 0:21 13m $1500.00]\n" // tx+time
            + "Walk 10m ~ B ~ BUS R1 0:10 0:20 ~ F ~ Walk 1m [0:00 0:21 21m $1500.00]",    // tx
        pathsToString(response)
    );
  }
}

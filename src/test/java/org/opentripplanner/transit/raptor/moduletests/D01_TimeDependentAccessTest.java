...
public class D01_TimeDependentAccessTest implements RaptorTestConstants {
    ...
    public void openInWholeSearchIntervalTest() {
        ...
        assertEquals(
                ""
                        + "Walk 2m ~ 2 ~ BUS R1 0:15 0:30 ~ 5 ~ Walk 1m [00:13:00 00:31:00 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:20 0:35 ~ 5 ~ Walk 1m [00:18:00 00:36:00 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:25 0:40 ~ 5 ~ Walk 1m [00:23:00 00:41:00 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:30 0:45 ~ 5 ~ Walk 1m [00:28:00 00:46:00 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:15+1d 0:30+1d ~ 5 ~ Walk 1m [00:13:00+1d 00:31:00+1d 18m $2220]",
    ...
    public void openInWholeSearchIntervalTestFullDay() {
        ...
        assertEquals(
                ""
                        ...
                        + "Walk 2m ~ 2 ~ BUS R1 0:30 0:45 ~ 5 ~ Walk 1m [00:28:00 00:46:00 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:15+1d 0:30+1d ~ 5 ~ Walk 1m [00:13:00+1d 00:31:00+1d 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:20+1d 0:35+1d ~ 5 ~ Walk 1m [00:18:00+1d 00:36:00+1d 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:25+1d 0:40+1d ~ 5 ~ Walk 1m [00:23:00+1d 00:41:00+1d 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:30+1d 0:45+1d ~ 5 ~ Walk 1m [00:28:00+1d 00:46:00+1d 18m $2220]",
                pathsToString(response)
        );
    }
    ...
    public void openInSecondHalfIntervalTest() {
        ...
        assertEquals(
                ""
                        ...
                        + "Walk 2m ~ 2 ~ BUS R1 0:15+1d 0:30+1d ~ 5 ~ Walk 1m [01:00:00 00:31:00+1d 23h31m $85800]",
                pathsToString(response)
        );
    }
    ...
    public void openInFirstHalfIntervalTest() {
        ...
        assertEquals(
                ""
                        + "Walk 2m ~ 2 ~ BUS R1 0:15 0:30 ~ 5 ~ Walk 1m [00:13:00 00:31:00 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:20 0:35 ~ 5 ~ Walk 1m [00:18:00 00:36:00 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:25 0:40 ~ 5 ~ Walk 1m [00:20:00 00:41:00 21m $2400]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:15+1d 0:30+1d ~ 5 ~ Walk 1m [00:13:00+1d 00:31:00+1d 18m $2220]",
                pathsToString(response)
        );
    }
    ...
    public void openInFirstHalfIntervalTestFullDay() {
        ...
        assertEquals( ""
                        ...
                        + "Walk 2m ~ 2 ~ BUS R1 0:15+1d 0:30+1d ~ 5 ~ Walk 1m [00:13:00+1d 00:31:00+1d 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:20+1d 0:35+1d ~ 5 ~ Walk 1m [00:18:00+1d 00:36:00+1d 18m $2220]\n"
                        + "Walk 2m ~ 2 ~ BUS R1 0:25+1d 0:40+1d ~ 5 ~ Walk 1m [00:20:00+1d 00:41:00+1d 21m $2400]",
                pathsToString(response)
        );
    }

...
public class B11_FlexEgressTest implements RaptorTestConstants {
  ...
  public void multiCriteria() {
    ...
    assertEquals(""
            + "Walk 1m ~ B ~ BUS R1 0:10 0:14 ~ D ~ Flex 3m 2x [0:09 0:18 9m $1380.00]\n"
            + "Walk 1m ~ B ~ BUS R1 0:10 0:16 ~ E ~ Flex 1m59s 2x [0:09 0:18:59 9m59s $1378.00]\n"
            + "Walk 1m ~ B ~ BUS R1 0:10 0:12 ~ C ~ Flex 7m 1x [0:09 0:20 11m $1740.00]\n"
            + "Walk 1m ~ B ~ BUS R1 0:10 0:18 ~ F ~ Walk 10m [0:09 0:28 19m $2400.00]",
            pathsToString(response)
    );
  }
}
...
import static org.opentripplanner.transit.model.trip.timetable.AlightTimeSearch.findAlightTime;

import org.junit.jupiter.api.BeforeEach;
import org.junit.jupiter.api.Test;

class AlightTimeSearchTest {
  ...
  void findDepartureInTimetableWith200Elements() {
    testSearch(AlightTimeSearch::findAlightTime);
    testSearch(AlightTimeSearch::findAlightTimeLinearApproximation);
    testSearch(AlightTimeSearch::findAlightTimeBinarySearch);
  }
  ...
  void testSearch(TimeSearch search) {
    ...
    assertEquals(2, search.search(MANY, start, end, 11));

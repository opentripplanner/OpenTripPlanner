...
public class OrcaFareServiceTest {
    ...
    private static Stream<Arguments> createRoutes() {
        return Stream.of(
            ...
            Arguments.of("Community Transit", 3, "", Fare.FareType.orcaSenior, 1.25f),
            Arguments.of("Community Transit", 1, "", Fare.FareType.orcaSenior, 2f),
            ...
            Arguments.of("Metro Transit", 4, "Water Taxi: West Seattle", Fare.FareType.orcaSenior, 2.5f),
            ...
            Arguments.of("Metro Transit", 4, "Water Taxi: Vashon Island", Fare.FareType.orcaSenior, 3f),
            ...
            Arguments.of("Sound Transit", -1, "", Fare.FareType.orcaSenior, 1f),
            ...
            Arguments.of("Everett Transit", -1, "", Fare.FareType.orcaSenior, 0.5f),
            ...
            Arguments.of("Pierce Transit", -1, "", Fare.FareType.orcaSenior, 1f),
            ...
            Arguments.of("City of Seattle", -1, "", Fare.FareType.orcaSenior, 1f),
            ...
            Arguments.of("Washington State Ferries", -1, "", Fare.FareType.orcaSenior, null),
            ...
            Arguments.of("Kitsap Transit", -1, "", Fare.FareType.orcaSenior, 1f),

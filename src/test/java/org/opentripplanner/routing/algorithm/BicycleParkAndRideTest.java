    ...
    public void setUp() throws Exception {
        graph = graphOf(new Builder() {
            ...
            public void build() {
                ...
                vehicleParking("AllPark", 47.500, 19.001, true, true,
                        List.of(
                                vehicleParkingEntrance(A, "All Park Entrance", true, true)
                        )
                );

                vehicleParking("BikePark", 47.520, 19.001, true, false,
                        List.of(
                                vehicleParkingEntrance(C, "BikePark Entrance", false, true)
                        )
                );

                vehicleParking("CarPark", 47.530, 19.001, false, true,
                        List.of(
                                vehicleParkingEntrance(D, "CarPark Entrance", true, true)
                        )
                );
            }
        });

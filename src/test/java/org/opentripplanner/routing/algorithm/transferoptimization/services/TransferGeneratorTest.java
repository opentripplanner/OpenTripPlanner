...
public class TransferGeneratorTest implements RaptorTestConstants {
  ...
  void findGuaranteedTransferWithNoSlack() {
    ...
    data
      .withTransfer(STOP_C, TestTransfer.walkTransfer(STOP_D, D1m))
  ...
  void findTransferForDifferentRoutes() {
    ...
    data
      .withRoutes(l1, l2)
      .withTransfer(STOP_B, TestTransfer.walkTransfer(STOP_E, D1m))
      .withTransfer(STOP_D, TestTransfer.walkTransfer(STOP_F, D20s));
  ...
  void findTransfersForCircularLine2() {
    ...
    data.withRoutes(l1, l2).withTransfer(STOP_D, TestTransfer.walkTransfer(STOP_E, D1m));
  ...
  void findTransferWithAlightingForbiddenAtSameStop() {
    ...
    data.withRoutes(l1, l2).withTransfer(STOP_C, TestTransfer.walkTransfer(STOP_D, D1m));
  ...
  void findDependedTransfersForThreeRoutes() {
    ...
    data
      .withRoutes(l1, l2, l3)
      .withTransfer(STOP_C, TestTransfer.walkTransfer(STOP_D, D30s))
      .withTransfer(STOP_D, TestTransfer.walkTransfer(STOP_F, D20s));

  ...
  private StreetVertex A, B, C, D, E, F;
    ...
    public void setUp() throws Exception {
        graph = graphOf(new Builder() {
            ...
            public void build() {
                ...
                vehicleParking("CarPark #1", 47.505, 19.001, false, true,
                        List.of(
                ...
                vehicleParking("AllPark", 47.520, 19.001, true, true,
                        List.of(
                                vehicleParkingEntrance(C, "AllPark Entrance", true, true)
                        )
                );
                ...
                vehicleParking("BikePark", 47.540, 19.000, true, false,
                        List.of(
                                vehicleParkingEntrance(E, "BikePark Entrance", false, true)
                        )
                );
            }
        });
    ...
    public void carParkingToCarAndBicycleParkingPlaceTest() {
        assertPath(
                ...
                "WALK (parked) - DE street (503.65, 312)",
                "WALK (parked) - EF street (634.48, 378)"
        );
    }

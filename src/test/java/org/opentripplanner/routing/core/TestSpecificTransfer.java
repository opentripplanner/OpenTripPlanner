...
public class TestSpecificTransfer extends TestCase {
    ...
    public void testSpecificTransfer() {
        ...
        SpecificTransfer s2 = new SpecificTransfer((FeedId) null, null, null, null, 2);
        ...
        SpecificTransfer s4 = new SpecificTransfer(fromRoute.getId(), toRoute.getId(), new FeedId("A1", "T3"), toTrip.getId(), 4);

...
public class TestHalfEdges {
    ...
    public void testHalfEdges() {
        ...
        RequestScopedStreetLocation start = StreetVertexIndex.createTemporaryStreetLocation(graph, "start", new NonLocalizedString("start"),
        ...
        RequestScopedStreetLocation end = StreetVertexIndex.createTemporaryStreetLocation(graph, "end", new NonLocalizedString("end"),
    ...
    public void testStreetLocationFinder() {
        ...
        RequestScopedStreetLocation some = (RequestScopedStreetLocation) finder.getVertexForLocation(
                new GenericLocation(40.00, -74.00), null, true);
        assertNotNull(some);

        // test that the closest vertex finder correctly splits streets
        RequestScopedStreetLocation start = (RequestScopedStreetLocation) finder.getVertexForLocation(
        ...
        RequestScopedStreetLocation end = (RequestScopedStreetLocation) finder.getVertexForLocation(
        ...
        start = (RequestScopedStreetLocation) finder.getVertexForLocation(
                new GenericLocation(40.004, -74.0), walking, false);
        end = (RequestScopedStreetLocation) finder.getVertexForLocation(

...
class DebugRaptorTest {
    ...
    private DebugRaptor subject() { return new DebugRaptor(); }
    ...
    void testToString() {
        assertEquals(
                "DebugRaptor{stops: 12}",
                subject().withStops("12").toString()
        );
        assertEquals(
                "DebugRaptor{path: 13, 22*}",
                subject().withPath("13 22*").toString()
        );
        assertEquals(
                "DebugRaptor{path: 17, 2*, 32}",
                subject().withPath("17 2* 32*").toString()
        );
    }
}
...
public final class ServiceInterval implements Serializable {
    ...
    public ServiceInterval extend(int arrivalTime, int departureTime) {
        ...
        return new ServiceInterval(minArrivalTime, minDepartureTime, maxArrivalTime,
                maxDepartureTime);
    }

    public static ServiceInterval extend(ServiceInterval serviceInterval, int arrivalTime,
            int departureTime) {
    ...
    public String toString() {
        return "Interval(min=" + minArrival + "," + minDeparture + " max=" + maxArrival + ","
                + maxDeparture + ")";
    }
}

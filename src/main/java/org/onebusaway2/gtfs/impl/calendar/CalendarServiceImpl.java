...
public class CalendarServiceImpl implements CalendarService {
    ...
    @Override
    public LocalizedServiceId getLocalizedServiceIdForAgencyAndServiceId(String agencyId,
    ...
    @Override
    public List<Date> getServiceDateArrivalsWithinRange(LocalizedServiceId serviceId,
            ServiceInterval interval, Date from, Date to) {
        return getServiceDates(getData(), serviceId, interval, ServiceIdOp.ARRIVAL_OP, to, from,
                false);
    }
    ...
    @Override
    public List<Date> getServiceDateDeparturesWithinRange(LocalizedServiceId serviceId,
            ServiceInterval interval, Date from, Date to) {
        return getServiceDates(getData(), serviceId, interval, ServiceIdOp.DEPARTURE_OP, from, to,
                false);
    }
    ...
    public List<Date> getServiceDatesWithinRange(LocalizedServiceId serviceId,
            ServiceInterval interval, Date from, Date to) {
        return getServiceDates(getData(), serviceId, interval, ServiceIdOp.BOTH_OP, from, to,
                false);
    }
    ...
    public List<Date> getNextDepartureServiceDates(LocalizedServiceId serviceId,
        ...
        return getServiceDates(getData(), serviceId, interval, ServiceIdOp.DEPARTURE_OP, target,
                target, true);
    }
    ...
    @Override
    public List<Date> getPreviousArrivalServiceDates(LocalizedServiceId serviceId,
            ServiceInterval interval, long targetTime) {
        Date target = new Date(targetTime);
        return getServiceDates(getData(), serviceId, interval, ServiceIdOp.ARRIVAL_OP, target,
                target, true);
    }
  ...
  /* Private Methods */
    ...
    private Map<LocalizedServiceId, List<Date>> getServiceDates(
            ServiceIdIntervals serviceIdIntervals, ServiceIdOp op, Date from, Date to,
        ...
        for (Map.Entry<LocalizedServiceId, ServiceInterval> entry : serviceIdIntervals) {
            ...
            List<Date> serviceDates = getServiceDates(allData, serviceId, interval, op, from, to,
                    includeNextDate);
    ...
    private List<Date> getServiceDates(CalendarServiceData allData, LocalizedServiceId serviceId,
            ServiceInterval interval, ServiceIdOp op, Date from, Date to,
    ...
    private int search(List<Date> serviceDates, ServiceIdOp op, int indexFrom, int indexTo,
            Date key) {

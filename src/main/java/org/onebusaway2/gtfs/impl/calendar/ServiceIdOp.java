...
public abstract class ServiceIdOp implements Comparator<Date> {
    ...
    static final ServiceIdOp ARRIVAL_OP = new ArrivalsServiceDateTimeOp();

    static final ServiceIdOp DEPARTURE_OP = new DeparturesServiceDateTimeOp();

    static final ServiceIdOp BOTH_OP = new MaxRangeServiceDateTimeOp();

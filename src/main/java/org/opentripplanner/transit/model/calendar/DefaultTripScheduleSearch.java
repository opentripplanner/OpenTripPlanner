...
public class DefaultTripScheduleSearch implements RaptorTripScheduleSearch<TripOnDay> {
  @Override
  public RaptorBoardOrAlightEvent<TripOnDay> search(int earliestBoardTime, int stopPositionInPattern) {
    return RaptorTripScheduleSearch.super.search(earliestBoardTime, stopPositionInPattern);
  }

  @Override
  public RaptorBoardOrAlightEvent<TripOnDay> search(int earliestBoardTime, int stopPositionInPattern, int tripIndexLimit) {
    return null;
  }
}

...
public class GroupStop
  ...
  /**
   * Returns the geometry of the area that encompasses the bounds of this StopLocation group. If
   * the group is defined as all the stops within an area, then this
   * will return the geometry of the area. If the group is defined simply as a list of stops, this will return an empty optional.
   */
  @Override

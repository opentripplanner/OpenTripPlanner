...
public class StopModel implements Serializable {
  ...
  /**
   * Find regular stops within a geographical area represented by an Envelope object.
   */
  ...
  /**
   * Find flex stops within a geographical area represented by an Envelope object.
   */
  ...
  /**
   * Find flex groups of stops within a geographical area represented by an Envelope object.
   */
  public Collection<GroupStop> findGroupStops(Envelope envelope) {
    return index.findGroupStops(envelope);
  }

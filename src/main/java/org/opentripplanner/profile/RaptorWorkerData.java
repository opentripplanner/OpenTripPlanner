    ...
    public TIntIntMap findStopsNear (ShortestPathTree spt, Graph graph, boolean useTimes, float walkSpeed) {
            ...
            if (s != null) {
                ...
                if (stopIndex != -1) {
                    if (useTimes)
                        ...
                        accessTimes.put(stopIndex, (int) (s.getTraverseDistanceInMeters() / walkSpeed));
                }
            }
        }
        ...
        for (TObjectIntIterator<AddTripPattern.TemporaryStop> it = addedStops.iterator(); it.hasNext();) {
            ...
            if (tstop.sample.v0 != null) {
                ...
                if (s0 != null) {
                    dist = s0.getTraverseDistanceInMeters() + tstop.sample.d0;
                }
            }
            ...
            if (tstop.sample.v1 != null) {
                ...
                if (s1 != null) {
                    double d1 = s1.getTraverseDistanceInMeters() + tstop.sample.d1;

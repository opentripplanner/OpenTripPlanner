 ...
 */
public class TNRaptorWorker {

    private static final Logger LOG = LoggerFactory.getLogger(TNRaptorWorker.class);
    ...
    public TNRaptorWorker(RaptorWorkerData data, ProfileRequest req) {
        this.data = data;
     ...
     */
    public TNPropagatedTimesStore runRaptor (TIntIntMap accessTimes, PointSetTimes nonTransitTimes, TaskStatistics ts) {
        ...
        TNPropagatedTimesStore propagatedTimesStore = new TNPropagatedTimesStore(data.nTargets);

 ...
 * <p>
 * The envelope is bound at graph build time. Ba aware that before the envelope is set, accessing
 * it will cause a null pointer exception.
 * <p>
 * The implementation must be THREAD-SAFE.
 * <p>
 * This serve as an example for creating a service backed by a repository. In this case it would
 ...
 * world-envelope-graph-builder is the only component witch need the repository and making it titer

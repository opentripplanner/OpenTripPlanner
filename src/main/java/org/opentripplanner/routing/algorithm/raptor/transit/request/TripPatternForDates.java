                ...
                RaptorTripPattern<TripSchedule>
{
    ...
    public Iterable<TripSchedule> listTripSchedules() {
        return () -> new Iterator<>() {
            int i=0;
            @Override public boolean hasNext() { return i < numberOfTripSchedules; }
            @Override public TripSchedule next() { return getTripSchedule(i++); }
        };
    }

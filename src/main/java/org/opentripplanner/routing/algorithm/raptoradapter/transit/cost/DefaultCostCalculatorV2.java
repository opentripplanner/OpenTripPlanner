...
public final class DefaultCostCalculatorV2<T extends TripOnDay> implements CostCalculator<T> {
   ...
   */
  public DefaultCostCalculatorV2(
    int boardCost,
    int transferCost,
  ...
  public DefaultCostCalculatorV2(GeneralizedCostParameters params, int[] stopTransferCost) {
    this(
      params.boardCost(),
      params.transferCost(),
  ...
  @Override
  public int onTripRelativeRidingCost(int boardTime, TripOnDay tripScheduledBoarded) {

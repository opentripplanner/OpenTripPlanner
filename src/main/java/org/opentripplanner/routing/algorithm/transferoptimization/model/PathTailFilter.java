 ...
 * feed in paths witch can be compared. If the head is alighted at a position which gives it an
...
public interface PathTailFilter<T extends RaptorTripSchedule> {
   ...
   * calculating the property witch is used for comparison. If the comparison can be done without

...
public interface StreetEdgeCarSpeedProvider {
    ...
    /**
     * Note that we pass the edge as a parameter to the provider, as some implementation could be
     * shared for multiple edges (for example a provider for an exclusion zone).
     */

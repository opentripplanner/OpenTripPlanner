...
public enum StreetMode implements DocumentedEnum<StreetMode> {
   ...
   * of the search.
   */
  NOT_SET(true, true, true, false, false, false, false, false, false, false),
  /**
   * Walk only
   */
  WALK(true, true, true, true, false, false, false, false, false, false),
  /**
   * Bike only
   */
  BIKE(true, true, true, false, true, false, false, false, false, false),
  /**
   * Bike to a bike parking area, then walk the rest of the way.
   * <p>
   * Direct mode and access mode only.
   */
  BIKE_TO_PARK(true, false, false, true, true, false, false, false, true, false),
  /**
   ...
   */
  BIKE_RENTAL(true, true, true, true, true, false, false, true, false, false),
  /**
   ...
   */
  SCOOTER_RENTAL(true, true, true, true, false, false, true, true, false, false),
  /**
   * Car only
   * <p>
   * Direct mode only.
   */
  CAR(true, false, false, false, false, true, false, false, false, false),
  /**
   * Start in the car, drive to a parking area, and walk the rest of the way.
   * <p>
   * Direct mode and access mode only.
   */
  CAR_TO_PARK(true, false, false, true, false, true, false, false, true, false),
  /**
   ...
   */
  CAR_PICKUP(true, false, true, true, false, true, false, false, false, true),
  /**
   ...
   */
  CAR_RENTAL(true, true, true, true, false, true, false, true, false, false),

  /**
   * Using a car hailing app like Uber or Lyft to get to a train station or all the way to the destination.
   */
  CAR_HAILING(true, false, true, false, false, true, false, false, false, true),

  /**
   * Encompasses all types of on-demand and flexible transportation.
   */
  FLEXIBLE(true, false, true, true, false, false, false, false, false, false);
  ...
  StreetMode(
    ...
    this.includesScooter = includesScooter;

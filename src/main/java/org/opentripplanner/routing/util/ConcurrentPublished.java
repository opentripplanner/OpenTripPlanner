...
/**
 * This class is used in a situation where an updater thread wants to create a sequence of
 * objects over time and share them with a pool of reader threads.
 *
 ...
 * guarantee that the combined process of assigning to fields of X and then assigning a reference
 * to X is atomic.
 *

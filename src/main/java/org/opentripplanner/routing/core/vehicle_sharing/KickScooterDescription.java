...
public class KickScooterDescription extends VehicleDescription {
    ...
    private static final double MAX_SPEED_IN_METERS_PER_SECOND_ON_BIKEPATH = 4.1;
    private static final double MAX_SPEED_IN_METERS_PER_SECOND_ON_PEDESTRIAN_PATH = 2.7;

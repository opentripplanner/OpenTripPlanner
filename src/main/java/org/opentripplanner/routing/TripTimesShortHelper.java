...
public class TripTimesShortHelper {
  ...
  public static List<TripTimeOnDate> getTripTimesShort(
    ...
    if (
      !transitService
        .getServicesRunningForDate(serviceDate.toLocalDate())
        .contains(times.getServiceCode())
    ) {
      ...
      Instant midnight = ServiceDateUtils
        ...
        .toInstant();
      return TripTimeOnDate.fromTripTimes(timetable, trip, serviceDate.toLocalDate(), midnight);
    }
  }
}

...
public class AlternativeLegs {
   ...
   *                        If false, all stops belonging to the same parent station are used.
   * @param exactDestinationStop Boolean indicating whether the exact destination stop of the original leg is used as destination stop for the alternatives.
   *                       If false, all stops belonging to the same parent station are used.
   */
  public static List<ScheduledTransitLeg> getAlternativeLegs(
    Leg leg,

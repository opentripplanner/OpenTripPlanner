...
public class ByteArrayDataSource implements DataSource {
    ...
    ByteArrayDataSource(
            String path, String name, FileType type, long size, long lastModified, boolean writable
    ) {
        this.path = path;
        this.name = name;
        this.type = type;
     ...
     * will throw an exception, instead use the {@link #withBytes(byte[])} to inject data.
     */
    @Override

 ...
 * 
 * Our solution is to serialize the FeedId as a single string with a separator character
 ...
 * 
 * Since FeedId is a third-party class, we can't modify it with a custom serialization method
...
public class JSONObjectMapperProvider implements ContextResolver<ObjectMapper> {
    ...
    public JSONObjectMapperProvider() {
        ...
        mapper = new ObjectMapper()
                .registerModule(FeedIdSerializer.makeModule())

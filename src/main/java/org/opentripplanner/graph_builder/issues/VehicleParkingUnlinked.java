...
public class VehicleParkingUnlinked implements DataImportIssue {
  ...
  private static final String FMT =
    "Vehicle parking %s not near any streets; it will not be usable.";
  private static final String HTMLFMT =
    "Vehicle parking <a href=\"http://www.openstreetmap.org/?mlat=%s&mlon=%s\">\"%s\"</a> not near any streets; it will not be usable.";
  ...
  public String getHTMLMessage() {
    return String.format(
      HTMLFMT,
      vehicleParkingEntranceVertex.getLat(),

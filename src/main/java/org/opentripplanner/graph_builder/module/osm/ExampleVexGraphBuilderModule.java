...
/**
 * This is an older, now incorrect attempt at loading directly from a VEX server.
 * I'm keeping it around as an example until we get fromVexStream() and fromVexServer() implemented in the OSMLib.
 */
public abstract class ExampleVexGraphBuilderModule implements GraphBuilderModule {

    private static final Logger LOG = LoggerFactory.getLogger(ExampleVexGraphBuilderModule.class);
    ...
    public static class PBFModule extends ExampleVexGraphBuilderModule {
    ...
    public static class VexServerModule extends ExampleVexGraphBuilderModule {

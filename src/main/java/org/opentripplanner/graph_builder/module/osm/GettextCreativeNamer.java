 ...
 */
public class GettextCreativeNamer extends CreativeNamer {
    ...
    public GettextCreativeNamer(String pattern) {
        this.creativeNamePattern = pattern;
    }

    public GettextCreativeNamer(T pattern) {
        this.creativeNameLocalPattern = pattern;
        this.creativeNamePattern = pattern.msgid;
    }

    public GettextCreativeNamer() {
    }

    public I18NString generateCreativeName(OSMWithTags way) {
        return new GettextLocalizedString(creativeNameLocalPattern, way);
    }

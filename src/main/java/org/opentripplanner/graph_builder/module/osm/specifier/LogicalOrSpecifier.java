 ...
 * safety mixin.
 * <p>
 * For example if you specify ("lcn=yes", "rnc=yes", "ncn=yes") then this will match if one of these
 * tags matches.
 * <p>
 * Background: If you would add 3 separate matches that would mean that a way that is matched with
 * all of them would receive too high a safety value leading to undesired detours.
 * <p>

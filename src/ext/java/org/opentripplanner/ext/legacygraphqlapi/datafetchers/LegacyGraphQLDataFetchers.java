...
import org.opentripplanner.ext.legacygraphqlapi.datafetchers.LegacyGraphQLTypes.LegacyGraphQLAlertCauseType;
...
public class LegacyGraphQLDataFetchers {
  ...
  public interface LegacyGraphQLAlert {
    ...
    public DataFetcher<Iterable<TranslatedString>> alertHeaderTextTranslations();
    public DataFetcher<String> alertDescriptionText();
    public DataFetcher<Iterable<TranslatedString>> alertDescriptionTextTranslations();
    public DataFetcher<String> alertUrl();
    public DataFetcher<Iterable<TranslatedString>> alertUrlTranslations();
  ...
  public interface LegacyGraphQLLeg {
    ...
    public DataFetcher<Agency> agency();
    public DataFetcher<Boolean> realTime();
    public DataFetcher<Object> realtimeState();
    public DataFetcher<Double> distance();
  ...
  public interface LegacyGraphQLPlace {
    public DataFetcher<String> name();
    public DataFetcher<Object> vertexType();
    public DataFetcher<Double> lat();
    public DataFetcher<Double> lon();
  ...
  public interface LegacyGraphQLRoute {
    ...
    public DataFetcher<Object> bikesAllowed();
    public DataFetcher<Iterable<TripPattern>> patterns();
    public DataFetcher<Iterable<Stop>> stops();
    public DataFetcher<Iterable<Trip>> trips();
    public DataFetcher<Iterable<Alert>> alerts();
  ...
  public interface LegacyGraphQLStoptime {
    ...
    public DataFetcher<Boolean> realtime();
    public DataFetcher<Object> realtimeState();
    public DataFetcher<Object> pickupType();
    public DataFetcher<Object> dropoffType();

...
public class LegacyGraphQLNodeTypeResolver implements TypeResolver {
  ...
  public GraphQLObjectType getType(TypeResolutionEnvironment environment) {
    ...
    if (o instanceof PlaceAndDistance) return schema.getObjectType("placeAtDistance");
    ...
    if (o instanceof StopAndDistance) return schema.getObjectType("stopAtDistance");

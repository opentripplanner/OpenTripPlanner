...
public class LegacyGraphQLTypes {
  ...
  public static class LegacyGraphQLInputVehicleParkingInput {
    ...
    private Iterable<String> bannedTags;
    private Iterable<String> preferredTags;
    private Iterable<String> requiredTags;
    private Integer unpreferredTagCost;

    public LegacyGraphQLInputVehicleParkingInput(Map<String, Object> args) {
      if (args != null) {
        this.bannedTags = (Iterable<String>) args.get("bannedTags");
        this.preferredTags = (Iterable<String>) args.get("preferredTags");
        this.requiredTags = (Iterable<String>) args.get("requiredTags");
        this.unpreferredTagCost = (Integer) args.get("unpreferredTagCost");
      }
    }

    public Iterable<String> getLegacyGraphQLBannedTags() {
      return this.bannedTags;
    }

    public Iterable<String> getLegacyGraphQLPreferredTags() {
      return this.preferredTags;
    }

    public Iterable<String> getLegacyGraphQLRequiredTags() {
      return this.requiredTags;
    }

    public Integer getLegacyGraphQLUnpreferredTagCost() {
      return this.unpreferredTagCost;
    }

    public void setLegacyGraphQLBannedTags(Iterable<String> bannedTags) {
      this.bannedTags = bannedTags;
    }

    public void setLegacyGraphQLPreferredTags(Iterable<String> preferredTags) {
      this.preferredTags = preferredTags;
    }

    public void setLegacyGraphQLRequiredTags(Iterable<String> requiredTags) {
      this.requiredTags = requiredTags;
    }

    public void setLegacyGraphQLUnpreferredTagCost(Integer unpreferredTagCost) {
      this.unpreferredTagCost = unpreferredTagCost;
    }
  }

...
public class LegacyGraphQLTypes {
  ...
  public static class LegacyGraphQLParkingFilterInput {
    ...
    private Iterable<LegacyGraphQLParkingFilterOperationInput> not;
    private Iterable<LegacyGraphQLParkingFilterOperationInput> select;

    public LegacyGraphQLParkingFilterInput(Map<String, Object> args) {
      if (args != null) {
        if (args.get("not") != null) {
          this.not = (Iterable<LegacyGraphQLParkingFilterOperationInput>) args.get("not");
        }
        if (args.get("select") != null) {
          this.select = (Iterable<LegacyGraphQLParkingFilterOperationInput>) args.get("select");
        }
      }
    }

    public Iterable<LegacyGraphQLParkingFilterOperationInput> getLegacyGraphQLNot() {
      return this.not;
    }

    public Iterable<LegacyGraphQLParkingFilterOperationInput> getLegacyGraphQLSelect() {
      return this.select;
    }

    public void setLegacyGraphQLNot(Iterable<LegacyGraphQLParkingFilterOperationInput> not) {
      this.not = not;
    }

    public void setLegacyGraphQLSelect(Iterable<LegacyGraphQLParkingFilterOperationInput> select) {
      this.select = select;
    }
  }
  ...
  public static class LegacyGraphQLParkingFilterOperationInput {
    ...
    private String feed;
    private Iterable<String> oneOfFeeds;
    private Iterable<String> oneOfTags;

    public LegacyGraphQLParkingFilterOperationInput(Map<String, Object> args) {
      if (args != null) {
        this.allTags = (Iterable<String>) args.get("allTags");
        this.feed = (String) args.get("feed");
        this.oneOfFeeds = (Iterable<String>) args.get("oneOfFeeds");
        this.oneOfTags = (Iterable<String>) args.get("oneOfTags");
      }
    }

    public Iterable<String> getLegacyGraphQLAllTags() {
      return this.allTags;
    }

    public String getLegacyGraphQLFeed() {
      return this.feed;
    }

    public Iterable<String> getLegacyGraphQLOneOfFeeds() {
      return this.oneOfFeeds;
    }

    public Iterable<String> getLegacyGraphQLOneOfTags() {
      return this.oneOfTags;
    }

    public void setLegacyGraphQLAllTags(Iterable<String> allTags) {
      this.allTags = allTags;
    }

    public void setLegacyGraphQLFeed(String feed) {
      this.feed = feed;
    }

    public void setLegacyGraphQLOneOfFeeds(Iterable<String> oneOfFeeds) {
      this.oneOfFeeds = oneOfFeeds;
    }

    public void setLegacyGraphQLOneOfTags(Iterable<String> oneOfTags) {
      this.oneOfTags = oneOfTags;
    }
  }
  ...
  public static class LegacyGraphQLVehicleParkingInput {
    ...
    private Iterable<LegacyGraphQLParkingFilterInput> filters;
    private Iterable<LegacyGraphQLParkingFilterInput> preferred;
    private Integer unpreferredCost;

    public LegacyGraphQLVehicleParkingInput(Map<String, Object> args) {
      if (args != null) {
        if (args.get("filters") != null) {
          this.filters = (Iterable<LegacyGraphQLParkingFilterInput>) args.get("filters");
        }
        if (args.get("preferred") != null) {
          this.preferred = (Iterable<LegacyGraphQLParkingFilterInput>) args.get("preferred");
        }
        this.unpreferredCost = (Integer) args.get("unpreferredCost");
      }
    }

    public Iterable<LegacyGraphQLParkingFilterInput> getLegacyGraphQLFilters() {
      return this.filters;
    }

    public Iterable<LegacyGraphQLParkingFilterInput> getLegacyGraphQLPreferred() {
      return this.preferred;
    }
    ...
    public void setLegacyGraphQLFilters(Iterable<LegacyGraphQLParkingFilterInput> filters) {
      this.filters = filters;
    }

    public void setLegacyGraphQLPreferred(Iterable<LegacyGraphQLParkingFilterInput> preferred) {
      this.preferred = preferred;
    }

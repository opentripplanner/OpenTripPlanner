...
public class LegacyGraphQLTypes {
  ...
  public static class LegacyGraphQLAgencyAlertsArgs {
      ...
      if (args != null) {
        if (args.get("types") != null) {
        		this.types = ((List<Object>) args.get("types")).stream()
        				.map(item -> item instanceof LegacyGraphQLAgencyAlertType ? item : LegacyGraphQLAgencyAlertType.valueOf((String) item))
    ...
    public void setLegacyGraphQLTypes(Iterable<LegacyGraphQLAgencyAlertType> types) { this.types = types; }
  }
  ...
  public static class LegacyGraphQLDepartureRowStoptimesArgs {
    ...
    public void setLegacyGraphQLNumberOfDepartures(Integer numberOfDepartures) { this.numberOfDepartures = numberOfDepartures; }
    public void setLegacyGraphQLOmitCanceled(Boolean omitCanceled) { this.omitCanceled = omitCanceled; }
    public void setLegacyGraphQLOmitNonPickups(Boolean omitNonPickups) { this.omitNonPickups = omitNonPickups; }
  ...
  public static class LegacyGraphQLFeedAlertsArgs {
    ...
    public LegacyGraphQLFeedAlertsArgs(Map<String, Object> args) {
      if (args != null) {
        if (args.get("types") != null) {
        		this.types = ((List<Object>) args.get("types")).stream()
        				.map(item -> item instanceof LegacyGraphQLFeedAlertType ? item : LegacyGraphQLFeedAlertType.valueOf((String) item))
    ...
    public void setLegacyGraphQLTypes(Iterable<LegacyGraphQLFeedAlertType> types) { this.types = types; }
  }
  ...
  public static class LegacyGraphQLInputCoordinatesInput {
    ...
    public void setLegacyGraphQLLocationSlack(Integer locationSlack) { this.locationSlack = locationSlack; }
  ...
  public static class LegacyGraphQLInputFiltersInput {
    ...
    public void setLegacyGraphQLBikeParks(Iterable<String> bikeParks) { this.bikeParks = bikeParks; }
    public void setLegacyGraphQLBikeRentalStations(Iterable<String> bikeRentalStations) { this.bikeRentalStations = bikeRentalStations; }
  ...
  public static class LegacyGraphQLInputPreferredInput {
    ...
    public String getLegacyGraphQLRoutes() { return this.routes; }
    public void setLegacyGraphQLAgencies(String agencies) { this.agencies = agencies; }
    public void setLegacyGraphQLOtherThanPreferredRoutesPenalty(Integer otherThanPreferredRoutesPenalty) { this.otherThanPreferredRoutesPenalty = otherThanPreferredRoutesPenalty; }
    public void setLegacyGraphQLRoutes(String routes) { this.routes = routes; }
  }
  public static class LegacyGraphQLInputTriangleInput {
    ...
    public void setLegacyGraphQLSafetyFactor(Double safetyFactor) { this.safetyFactor = safetyFactor; }
    public void setLegacyGraphQLSlopeFactor(Double slopeFactor) { this.slopeFactor = slopeFactor; }
  ...
  public static class LegacyGraphQLInputUnpreferredInput {
    ...
    public String getLegacyGraphQLAgencies() { return this.agencies; }
    public String getLegacyGraphQLRoutes() { return this.routes; }
    public String getLegacyGraphQLUnpreferredCost() { return this.unpreferredCost; }
    public Integer getLegacyGraphQLUseUnpreferredRoutesPenalty() { return this.useUnpreferredRoutesPenalty; }
    public void setLegacyGraphQLAgencies(String agencies) { this.agencies = agencies; }
    public void setLegacyGraphQLRoutes(String routes) { this.routes = routes; }
    public void setLegacyGraphQLUnpreferredCost(String unpreferredCost) { this.unpreferredCost = unpreferredCost; }
    public void setLegacyGraphQLUseUnpreferredRoutesPenalty(Integer useUnpreferredRoutesPenalty) { this.useUnpreferredRoutesPenalty = useUnpreferredRoutesPenalty; }
  }
  ...
  public static class LegacyGraphQLLegNextLegsArgs {
      ...
      if (args != null) {
        if (args.get("destinationModesWithParentStation") != null) {
        		this.destinationModesWithParentStation = ((List<Object>) args.get("destinationModesWithParentStation")).stream()
        				.map(item -> item instanceof LegacyGraphQLTransitMode ? item : LegacyGraphQLTransitMode.valueOf((String) item))
    ...
    public Iterable<LegacyGraphQLTransitMode> getLegacyGraphQLDestinationModesWithParentStation() { return this.destinationModesWithParentStation; }
    public Integer getLegacyGraphQLNumberOfLegs() { return this.numberOfLegs; }
    public Boolean getLegacyGraphQLOnlyFirstDestinationStop() { return this.onlyFirstDestinationStop; }
    public Iterable<LegacyGraphQLTransitMode> getLegacyGraphQLOriginModesWithParentStation() { return this.originModesWithParentStation; }
    public void setLegacyGraphQLDestinationModesWithParentStation(Iterable<LegacyGraphQLTransitMode> destinationModesWithParentStation) { this.destinationModesWithParentStation = destinationModesWithParentStation; }
    public void setLegacyGraphQLNumberOfLegs(Integer numberOfLegs) { this.numberOfLegs = numberOfLegs; }
    public void setLegacyGraphQLOnlyFirstDestinationStop(Boolean onlyFirstDestinationStop) { this.onlyFirstDestinationStop = onlyFirstDestinationStop; }
    public void setLegacyGraphQLOriginModesWithParentStation(Iterable<LegacyGraphQLTransitMode> originModesWithParentStation) { this.originModesWithParentStation = originModesWithParentStation; }
  }
  ...
  public static class LegacyGraphQLPatternAlertsArgs {
    ...
    public LegacyGraphQLPatternAlertsArgs(Map<String, Object> args) {
      if (args != null) {
        if (args.get("types") != null) {
        		this.types = ((List<Object>) args.get("types")).stream()
        				.map(item -> item instanceof LegacyGraphQLPatternAlertType ? item : LegacyGraphQLPatternAlertType.valueOf((String) item))
    ...
    public void setLegacyGraphQLTypes(Iterable<LegacyGraphQLPatternAlertType> types) { this.types = types; }
  }
  public static class LegacyGraphQLPatternTripsForDateArgs {
    ...
    public void setLegacyGraphQLServiceDate(String serviceDate) { this.serviceDate = serviceDate; }
  }
  ...
  public static class LegacyGraphQLQueryTypeAlertsArgs {
      ...
      if (args != null) {
        if (args.get("cause") != null) {
        		this.cause = ((List<Object>) args.get("cause")).stream()
        				.map(item -> item instanceof LegacyGraphQLAlertCauseType ? item : LegacyGraphQLAlertCauseType.valueOf((String) item))
        				.map(LegacyGraphQLAlertCauseType.class::cast)
        				.collect(Collectors.toList());
        }
        if (args.get("effect") != null) {
        		this.effect = ((List<Object>) args.get("effect")).stream()
        				.map(item -> item instanceof LegacyGraphQLAlertEffectType ? item : LegacyGraphQLAlertEffectType.valueOf((String) item))
        ...
        if (args.get("severityLevel") != null) {
        		this.severityLevel = ((List<Object>) args.get("severityLevel")).stream()
        				.map(item -> item instanceof LegacyGraphQLAlertSeverityLevelType ? item : LegacyGraphQLAlertSeverityLevelType.valueOf((String) item))
    ...
    public void setLegacyGraphQLCause(Iterable<LegacyGraphQLAlertCauseType> cause) { this.cause = cause; }
    public void setLegacyGraphQLEffect(Iterable<LegacyGraphQLAlertEffectType> effect) { this.effect = effect; }
    ...
    public void setLegacyGraphQLSeverityLevel(Iterable<LegacyGraphQLAlertSeverityLevelType> severityLevel) { this.severityLevel = severityLevel; }
  ...
  public static class LegacyGraphQLQueryTypeCancelledTripTimesArgs {
    ...
    public void setLegacyGraphQLFeeds(Iterable<String> feeds) { this.feeds = feeds; }
    public void setLegacyGraphQLMaxArrivalTime(Integer maxArrivalTime) { this.maxArrivalTime = maxArrivalTime; }
    public void setLegacyGraphQLMaxDate(String maxDate) { this.maxDate = maxDate; }
    public void setLegacyGraphQLMaxDepartureTime(Integer maxDepartureTime) { this.maxDepartureTime = maxDepartureTime; }
    public void setLegacyGraphQLMinArrivalTime(Integer minArrivalTime) { this.minArrivalTime = minArrivalTime; }
    public void setLegacyGraphQLMinDate(String minDate) { this.minDate = minDate; }
    public void setLegacyGraphQLMinDepartureTime(Integer minDepartureTime) { this.minDepartureTime = minDepartureTime; }
  ...
  public static class LegacyGraphQLQueryTypeNearestArgs {
    ...
    public LegacyGraphQLQueryTypeNearestArgs(Map<String, Object> args) {
      if (args != null) {
        ...
        this.filterByIds = new LegacyGraphQLInputFiltersInput((Map<String, Object>) args.get("filterByIds"));
        if (args.get("filterByModes") != null) {
        		this.filterByModes = ((List<Object>) args.get("filterByModes")).stream()
        				.map(item -> item instanceof LegacyGraphQLMode ? item : LegacyGraphQLMode.valueOf((String) item))
        ...
        if (args.get("filterByPlaceTypes") != null) {
        		this.filterByPlaceTypes = ((List<Object>) args.get("filterByPlaceTypes")).stream()
        				.map(item -> item instanceof LegacyGraphQLFilterPlaceType ? item : LegacyGraphQLFilterPlaceType.valueOf((String) item))
    ...
    public void setLegacyGraphQLFilterByIds(LegacyGraphQLInputFiltersInput filterByIds) { this.filterByIds = filterByIds; }
    public void setLegacyGraphQLFilterByModes(Iterable<LegacyGraphQLMode> filterByModes) { this.filterByModes = filterByModes; }
    public void setLegacyGraphQLFilterByPlaceTypes(Iterable<LegacyGraphQLFilterPlaceType> filterByPlaceTypes) { this.filterByPlaceTypes = filterByPlaceTypes; }
    ...
    public void setLegacyGraphQLLat(Double lat) { this.lat = lat; }
    public void setLegacyGraphQLLon(Double lon) { this.lon = lon; }
    public void setLegacyGraphQLMaxDistance(Integer maxDistance) { this.maxDistance = maxDistance; }
  ...
  public static class LegacyGraphQLQueryTypePlanArgs {
    ...
    public LegacyGraphQLQueryTypePlanArgs(Map<String, Object> args) {
      if (args != null) {
        ...
        this.allowedVehicleRentalNetworks = (Iterable<String>) args.get("allowedVehicleRentalNetworks");
        this.arriveBy = (Boolean) args.get("arriveBy");
        this.banned = new LegacyGraphQLInputBannedInput((Map<String, Object>) args.get("banned"));
        this.bannedVehicleRentalNetworks = (Iterable<String>) args.get("bannedVehicleRentalNetworks");
        ...
        if (args.get("intermediatePlaces") != null) {
        		this.intermediatePlaces = (Iterable<LegacyGraphQLInputCoordinatesInput>) args.get("intermediatePlaces");
        }
        ...
        this.modeWeight = new LegacyGraphQLInputModeWeightInput((Map<String, Object>) args.get("modeWeight"));
        ...
        this.preferred = new LegacyGraphQLInputPreferredInput((Map<String, Object>) args.get("preferred"));
        ...
        if (args.get("transportModes") != null) {
        		this.transportModes = (Iterable<LegacyGraphQLTransportModeInput>) args.get("transportModes");
        }
        this.triangle = new LegacyGraphQLInputTriangleInput((Map<String, Object>) args.get("triangle"));
        this.unpreferred = new LegacyGraphQLInputUnpreferredInput((Map<String, Object>) args.get("unpreferred"));
    ...
    public Iterable<String> getLegacyGraphQLAllowedVehicleRentalNetworks() { return this.allowedVehicleRentalNetworks; }
    ...
    public Iterable<String> getLegacyGraphQLBannedVehicleRentalNetworks() { return this.bannedVehicleRentalNetworks; }
    ...
    public Double getLegacyGraphQLWalkSafetyFactor() { return this.walkSafetyFactor; }
    ...
    public void setLegacyGraphQLAlightSlack(Integer alightSlack) { this.alightSlack = alightSlack; }
    public void setLegacyGraphQLAllowBikeRental(Boolean allowBikeRental) { this.allowBikeRental = allowBikeRental; }
    public void setLegacyGraphQLAllowKeepingRentedBicycleAtDestination(Boolean allowKeepingRentedBicycleAtDestination) { this.allowKeepingRentedBicycleAtDestination = allowKeepingRentedBicycleAtDestination; }
    public void setLegacyGraphQLAllowedBikeRentalNetworks(Iterable<String> allowedBikeRentalNetworks) { this.allowedBikeRentalNetworks = allowedBikeRentalNetworks; }
    public void setLegacyGraphQLAllowedTicketTypes(Iterable<String> allowedTicketTypes) { this.allowedTicketTypes = allowedTicketTypes; }
    public void setLegacyGraphQLAllowedVehicleRentalNetworks(Iterable<String> allowedVehicleRentalNetworks) { this.allowedVehicleRentalNetworks = allowedVehicleRentalNetworks; }
    public void setLegacyGraphQLArriveBy(Boolean arriveBy) { this.arriveBy = arriveBy; }
    public void setLegacyGraphQLBanned(LegacyGraphQLInputBannedInput banned) { this.banned = banned; }
    public void setLegacyGraphQLBannedVehicleRentalNetworks(Iterable<String> bannedVehicleRentalNetworks) { this.bannedVehicleRentalNetworks = bannedVehicleRentalNetworks; }
    public void setLegacyGraphQLBatch(Boolean batch) { this.batch = batch; }
    public void setLegacyGraphQLBikeBoardCost(Integer bikeBoardCost) { this.bikeBoardCost = bikeBoardCost; }
    public void setLegacyGraphQLBikeReluctance(Double bikeReluctance) { this.bikeReluctance = bikeReluctance; }
    public void setLegacyGraphQLBikeSpeed(Double bikeSpeed) { this.bikeSpeed = bikeSpeed; }
    public void setLegacyGraphQLBikeSwitchCost(Integer bikeSwitchCost) { this.bikeSwitchCost = bikeSwitchCost; }
    public void setLegacyGraphQLBikeSwitchTime(Integer bikeSwitchTime) { this.bikeSwitchTime = bikeSwitchTime; }
    public void setLegacyGraphQLBikeWalkingReluctance(Double bikeWalkingReluctance) { this.bikeWalkingReluctance = bikeWalkingReluctance; }
    public void setLegacyGraphQLBoardSlack(Integer boardSlack) { this.boardSlack = boardSlack; }
    public void setLegacyGraphQLCarParkCarLegWeight(Double carParkCarLegWeight) { this.carParkCarLegWeight = carParkCarLegWeight; }
    public void setLegacyGraphQLCarReluctance(Double carReluctance) { this.carReluctance = carReluctance; }
    public void setLegacyGraphQLClaimInitialWait(Long claimInitialWait) { this.claimInitialWait = claimInitialWait; }
    public void setLegacyGraphQLCompactLegsByReversedSearch(Boolean compactLegsByReversedSearch) { this.compactLegsByReversedSearch = compactLegsByReversedSearch; }
    public void setLegacyGraphQLDate(String date) { this.date = date; }
    public void setLegacyGraphQLDebugItineraryFilter(Boolean debugItineraryFilter) { this.debugItineraryFilter = debugItineraryFilter; }
    public void setLegacyGraphQLDisableRemainingWeightHeuristic(Boolean disableRemainingWeightHeuristic) { this.disableRemainingWeightHeuristic = disableRemainingWeightHeuristic; }
    public void setLegacyGraphQLFrom(LegacyGraphQLInputCoordinatesInput from) { this.from = from; }
    public void setLegacyGraphQLFromPlace(String fromPlace) { this.fromPlace = fromPlace; }
    public void setLegacyGraphQLHeuristicStepsPerMainStep(Integer heuristicStepsPerMainStep) { this.heuristicStepsPerMainStep = heuristicStepsPerMainStep; }
    public void setLegacyGraphQLIgnoreRealtimeUpdates(Boolean ignoreRealtimeUpdates) { this.ignoreRealtimeUpdates = ignoreRealtimeUpdates; }
    public void setLegacyGraphQLIntermediatePlaces(Iterable<LegacyGraphQLInputCoordinatesInput> intermediatePlaces) { this.intermediatePlaces = intermediatePlaces; }
    public void setLegacyGraphQLItineraryFiltering(Double itineraryFiltering) { this.itineraryFiltering = itineraryFiltering; }
    public void setLegacyGraphQLKeepingRentedBicycleAtDestinationCost(Integer keepingRentedBicycleAtDestinationCost) { this.keepingRentedBicycleAtDestinationCost = keepingRentedBicycleAtDestinationCost; }
    public void setLegacyGraphQLLocale(String locale) { this.locale = locale; }
    public void setLegacyGraphQLMaxPreTransitTime(Integer maxPreTransitTime) { this.maxPreTransitTime = maxPreTransitTime; }
    public void setLegacyGraphQLMaxTransfers(Integer maxTransfers) { this.maxTransfers = maxTransfers; }
    public void setLegacyGraphQLMaxWalkDistance(Double maxWalkDistance) { this.maxWalkDistance = maxWalkDistance; }
    public void setLegacyGraphQLMinTransferTime(Integer minTransferTime) { this.minTransferTime = minTransferTime; }
    public void setLegacyGraphQLModeWeight(LegacyGraphQLInputModeWeightInput modeWeight) { this.modeWeight = modeWeight; }
    public void setLegacyGraphQLNonpreferredTransferPenalty(Integer nonpreferredTransferPenalty) { this.nonpreferredTransferPenalty = nonpreferredTransferPenalty; }
    public void setLegacyGraphQLNumItineraries(Integer numItineraries) { this.numItineraries = numItineraries; }
    public void setLegacyGraphQLOmitCanceled(Boolean omitCanceled) { this.omitCanceled = omitCanceled; }
    public void setLegacyGraphQLOptimize(LegacyGraphQLOptimizeType optimize) { this.optimize = optimize; }
    public void setLegacyGraphQLPageCursor(String pageCursor) { this.pageCursor = pageCursor; }
    public void setLegacyGraphQLPreferred(LegacyGraphQLInputPreferredInput preferred) { this.preferred = preferred; }
    public void setLegacyGraphQLReverseOptimizeOnTheFly(Boolean reverseOptimizeOnTheFly) { this.reverseOptimizeOnTheFly = reverseOptimizeOnTheFly; }
    public void setLegacyGraphQLSearchWindow(Long searchWindow) { this.searchWindow = searchWindow; }
    public void setLegacyGraphQLStartTransitStopId(String startTransitStopId) { this.startTransitStopId = startTransitStopId; }
    public void setLegacyGraphQLStartTransitTripId(String startTransitTripId) { this.startTransitTripId = startTransitTripId; }
    ...
    public void setLegacyGraphQLTransferPenalty(Integer transferPenalty) { this.transferPenalty = transferPenalty; }
    public void setLegacyGraphQLTransportModes(Iterable<LegacyGraphQLTransportModeInput> transportModes) { this.transportModes = transportModes; }
    public void setLegacyGraphQLTriangle(LegacyGraphQLInputTriangleInput triangle) { this.triangle = triangle; }
    public void setLegacyGraphQLUnpreferred(LegacyGraphQLInputUnpreferredInput unpreferred) { this.unpreferred = unpreferred; }
    public void setLegacyGraphQLWaitAtBeginningFactor(Double waitAtBeginningFactor) { this.waitAtBeginningFactor = waitAtBeginningFactor; }
    public void setLegacyGraphQLWaitReluctance(Double waitReluctance) { this.waitReluctance = waitReluctance; }
    public void setLegacyGraphQLWalkBoardCost(Integer walkBoardCost) { this.walkBoardCost = walkBoardCost; }
    public void setLegacyGraphQLWalkOnStreetReluctance(Double walkOnStreetReluctance) { this.walkOnStreetReluctance = walkOnStreetReluctance; }
    public void setLegacyGraphQLWalkReluctance(Double walkReluctance) { this.walkReluctance = walkReluctance; }
    public void setLegacyGraphQLWalkSafetyFactor(Double walkSafetyFactor) { this.walkSafetyFactor = walkSafetyFactor; }
  ...
  public static class LegacyGraphQLQueryTypeRentalVehiclesArgs {
      ...
      if (args != null) {
        if (args.get("formFactors") != null) {
        		this.formFactors = ((List<Object>) args.get("formFactors")).stream()
        				.map(item -> item instanceof LegacyGraphQLFormFactor ? item : LegacyGraphQLFormFactor.valueOf((String) item))
    ...
    public Iterable<String> getLegacyGraphQLIds() { return this.ids; }
    public void setLegacyGraphQLFormFactors(Iterable<LegacyGraphQLFormFactor> formFactors) { this.formFactors = formFactors; }
    public void setLegacyGraphQLIds(Iterable<String> ids) { this.ids = ids; }
  }
  ...
  public static class LegacyGraphQLQueryTypeRoutesArgs {
    ...
    public void setLegacyGraphQLTransportModes(Iterable<LegacyGraphQLMode> transportModes) { this.transportModes = transportModes; }
  }
  ...
  public static class LegacyGraphQLRouteAlertsArgs {
    ...
    public LegacyGraphQLRouteAlertsArgs(Map<String, Object> args) {
      if (args != null) {
        if (args.get("types") != null) {
        		this.types = ((List<Object>) args.get("types")).stream()
        				.map(item -> item instanceof LegacyGraphQLRouteAlertType ? item : LegacyGraphQLRouteAlertType.valueOf((String) item))
    ...
    public void setLegacyGraphQLTypes(Iterable<LegacyGraphQLRouteAlertType> types) { this.types = types; }
  }
  ...
  public static class LegacyGraphQLStopAlertsArgs {
    ...
    public LegacyGraphQLStopAlertsArgs(Map<String, Object> args) {
      if (args != null) {
        if (args.get("types") != null) {
        		this.types = ((List<Object>) args.get("types")).stream()
        				.map(item -> item instanceof LegacyGraphQLStopAlertType ? item : LegacyGraphQLStopAlertType.valueOf((String) item))
    ...
    public void setLegacyGraphQLTypes(Iterable<LegacyGraphQLStopAlertType> types) { this.types = types; }
  }
  ...
  public static class LegacyGraphQLTransportModeInput {
    ...
    public void setLegacyGraphQLQualifier(LegacyGraphQLQualifier qualifier) { this.qualifier = qualifier; }
  }
  public static class LegacyGraphQLTripAlertsArgs {
    ...
    public LegacyGraphQLTripAlertsArgs(Map<String, Object> args) {
      if (args != null) {
        if (args.get("types") != null) {
        		this.types = ((List<Object>) args.get("types")).stream()
        				.map(item -> item instanceof LegacyGraphQLTripAlertType ? item : LegacyGraphQLTripAlertType.valueOf((String) item))
    ...
    public void setLegacyGraphQLTypes(Iterable<LegacyGraphQLTripAlertType> types) { this.types = types; }
  }

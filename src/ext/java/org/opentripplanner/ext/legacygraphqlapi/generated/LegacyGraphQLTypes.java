...
public class LegacyGraphQLTypes {
  ...
  public static class LegacyGraphQLLegNextLegsArgs {
    private Iterable<LegacyGraphQLMode> modesWithParentStation;
    private Integer numberOfLegs;
  
    public LegacyGraphQLLegNextLegsArgs(Map<String, Object> args) {
      if (args != null) {
        if (args.get("modesWithParentStation") != null) {
        		this.modesWithParentStation = ((List<Object>) args.get("modesWithParentStation")).stream()
    ...
    public Iterable<LegacyGraphQLMode> getLegacyGraphQLModesWithParentStation() { return this.modesWithParentStation; }
    public Integer getLegacyGraphQLNumberOfLegs() { return this.numberOfLegs; }
    public void setLegacyGraphQLModesWithParentStation(Iterable<LegacyGraphQLMode> modesWithParentStation) { this.modesWithParentStation = modesWithParentStation; }

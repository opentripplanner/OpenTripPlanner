    ...
    return GraphQLFieldDefinition
      ...
      .argument(
        GraphQLArgument
          ...
          .defaultValueLiteral(mapDurationForStreetModeGraphQLValue(preferences.street().maxAccessEgressDuration()))
          .build()
      )
      .argument(
        GraphQLArgument
          ...
          .type(new GraphQLList(new GraphQLNonNull(durationPerStreetModeType)))
          .defaultValueLiteral(mapDurationForStreetModeGraphQLValue(preferences.street().maxDirectDuration()))
          .build()
      )

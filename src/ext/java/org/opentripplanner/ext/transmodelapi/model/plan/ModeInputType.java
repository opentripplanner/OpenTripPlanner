...
import static org.opentripplanner.routing.api.request.RequestModes.defaultRequestModes;
...
class ModeInputType {
  static final GraphQLInputObjectType INPUT_TYPE = GraphQLInputObjectType
      ...
      .field(GraphQLInputObjectField
          .newInputObjectField()
          .name("accessMode")
          .defaultValue(defaultRequestModes.accessMode)
      ...
      .field(GraphQLInputObjectField
          .newInputObjectField()
          .name("egressMode")
          .defaultValue(defaultRequestModes.egressMode)
      ...
      .field(GraphQLInputObjectField
          .newInputObjectField()
          .name("directMode")
          .defaultValue(defaultRequestModes.directMode)
      ...
      .field(GraphQLInputObjectField
          .newInputObjectField()
          .name("transportMode")
          .defaultValue(defaultRequestModes.transitModes)

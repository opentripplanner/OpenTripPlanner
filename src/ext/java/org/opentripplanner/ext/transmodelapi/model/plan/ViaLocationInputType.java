...
import org.opentripplanner.ext.transmodelapi.model.framework.CoordinateInputType;
    ...
    return GraphQLInputObjectType
      ...
      .field(
        GraphQLInputObjectField
          .newInputObjectField()
          .name("minSlack")
          .defaultValue(ViaLocation.DEFAULT_MIN_SLACK)
          .description(
      ...
      .field(
        GraphQLInputObjectField
          .newInputObjectField()
          .name("maxSlack")
          .defaultValue(ViaLocation.DEFAULT_MAX_SLACK)
          .description(

...
//                                                                        .build())
        ...
        GraphQLFieldDefinition tripFieldType = GraphQLFieldDefinition.newFieldDefinition()
                ...
                .argument(GraphQLArgument.newArgument()
                        ...
                        .type(Scalars.GraphQLFloat)
                        .defaultValue(defaultRoutingRequest.preTransitPenalty)
                        .build())
                .argument(GraphQLArgument.newArgument()
        ...
        ptSituationElementType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("reportType")
                        .type(reportTypeEnum)
                        .description("ReportType of this situation. NOT IMPLEMENTED")
                        .dataFetcher(environment -> null)
                        .build())
                /*
                .field(GraphQLFieldDefinition.newFieldDefinition()
        ...
        stopPlaceType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(new GraphQLNonNull(Scalars.GraphQLID))
                        .dataFetcher(environment ->
                                mappingUtil.toIdString(((Station) environment.getSource()).getId()))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("name")
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("latitude")
                        .type(Scalars.GraphQLFloat)
                        .dataFetcher(environment -> (((Station) environment.getSource()).getLat()))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("longitude")
                        .type(Scalars.GraphQLFloat)
                        .dataFetcher(environment -> (((Station) environment.getSource()).getLon()))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("description")
                        .type(Scalars.GraphQLString)
                        .dataFetcher(environment -> (((Station) environment.getSource()).getDescription()))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("wheelchairBoarding")
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(new GraphQLList(Scalars.GraphQLString))
                        .dataFetcher(environment -> ((Station) environment.getSource()).getAdjacentSites())
                        .build())
                 */
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("timezone")
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .argument(GraphQLArgument.newArgument()
                                ...
                                .build())
                        .dataFetcher(environment -> {
                            Collection<Stop> quays = ((Station) environment.getSource()).getChildStops();
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .dataFetcher(environment -> {
                            ...
                            Station station = environment.getSource();
        ...
        serviceJourneyType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("situations")
                        .description("Get all situations active for the service journey. NOT IMPLEMENTED")
                        .type(new GraphQLNonNull(new GraphQLList(ptSituationElementType)))
        ...
        journeyPatternType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("situations")
                        .description("Get all situations active for the journey pattern. NOT IMPLEMENTED")
                        .type(new GraphQLNonNull(new GraphQLList(ptSituationElementType)))
                        .dataFetcher(dataFetchingEnvironment -> null)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
        ...
        lineType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("situations")
                        .description("Get all situations active for the line. NOT IMPLEMENTED")
                        .type(new GraphQLNonNull(new GraphQLList(ptSituationElementType)))
                        .dataFetcher(dataFetchingEnvironment -> null)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
        ...
        organisationType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("situations")
                        .description("Get all situations active for the organisation. NOT IMPLEMENTED")
                        .type(new GraphQLNonNull(new GraphQLList(ptSituationElementType)))
                        .dataFetcher(dataFetchingEnvironment -> null)
                        .build())
                .build();
        ...
        authorityType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("situations")
                        .description("Get all situations active for the authority. NOT IMPLEMENTED")
                        .type(new GraphQLNonNull(new GraphQLList(ptSituationElementType)))
                        .dataFetcher(dataFetchingEnvironment -> null)
                        .build())
                .build();
        ...
        queryType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .argument(GraphQLArgument.newArgument()
                                ...
                                .type(new GraphQLNonNull(Scalars.GraphQLString))
                                .build())
                        .dataFetcher(environment -> index.graph.stationById
                        ...
                        .dataFetcher(environment -> {
                            if ((environment.getArgument("ids") instanceof List)) {
                                return ((List<String>) environment.getArgument("ids"))
                                        .stream()
                                        .map(id -> index.graph.stationById.get(mappingUtil.fromIdString(id)))
                                        .collect(Collectors.toList());
                            }
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("situations")
                        .description("Get all active situations. NOT IMPLEMENTED")
                        .type(new GraphQLNonNull(new GraphQLList(ptSituationElementType)))
                        .argument(GraphQLArgument.newArgument()
                                .name("authorities")
                                .description("Filter by reporting authorities. NOT IMPLEMENTED")
                                .type(new GraphQLList(Scalars.GraphQLString))
                                .build())
                        .argument(GraphQLArgument.newArgument()
                                .name("severities")
                                .description("Filter by severity. NOT IMPLEMENTED")
    ...
    */
    ...
    private Collection<AlertPatch> getAllRelevantAlerts(TripTimeShort tripTimeShort) {
        ...
        FeedScopedId parentStopId = stop.getParentStationId();
    ...
    private void createPlanType() {
        ...
        routingParametersType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(Scalars.GraphQLFloat)
                        .dataFetcher(environment -> ((RoutingRequest) environment.getSource()).maxSlope)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(Scalars.GraphQLBoolean)
                        .dataFetcher(environment -> ((RoutingRequest) environment.getSource()).reverseOptimizeOnTheFly)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("compactLegsByReversedSearch")
                        .description("When true, do a full reversed search to compact the legs of the GraphPath.")
                        .type(Scalars.GraphQLBoolean)
                        .dataFetcher(environment -> ((RoutingRequest) environment.getSource()).compactLegsByReversedSearch)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(Scalars.GraphQLBoolean)
                        .dataFetcher(environment -> ((RoutingRequest) environment.getSource()).softWalkLimiting)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("softPreTransitLimiting")
                        .type(Scalars.GraphQLBoolean)
                        .dataFetcher(environment -> ((RoutingRequest) environment.getSource()).softPreTransitLimiting)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("softWalkPenalty")
                        .description("A jump in cost when stepping over the walking limit.")
                        .type(Scalars.GraphQLFloat)
                        .dataFetcher(environment -> ((RoutingRequest) environment.getSource()).softWalkPenalty)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("softWalkOverageRate")
                        .description("A jump in cost for every meter over the walking limit.")
                        .type(Scalars.GraphQLFloat)
                        .dataFetcher(environment -> ((RoutingRequest) environment.getSource()).softWalkOverageRate)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("preTransitPenalty")
                        .description("A jump in cost when stepping over the pre-transit time limit.")
                        .type(Scalars.GraphQLFloat)
                        .dataFetcher(environment -> ((RoutingRequest) environment.getSource()).preTransitPenalty)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("preTransitOverageRate")
                        .description("A jump in cost for every second over the pre-transit time limit.")
                        .type(Scalars.GraphQLFloat)
                        .dataFetcher(environment -> ((RoutingRequest) environment.getSource()).preTransitOverageRate)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("allowBikeRental")
                        .description("")

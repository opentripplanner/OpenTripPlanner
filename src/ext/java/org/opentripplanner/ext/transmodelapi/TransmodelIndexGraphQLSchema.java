...
public class TransmodelIndexGraphQLSchema {
    ...
    private static GraphQLEnumType vertexTypeEnum = GraphQLEnumType.newEnum()
            .name("VertexType")
            .value("normal", ApiVertexType.NORMAL)
            .value("transit", ApiVertexType.TRANSIT)
            .value("bikePark", ApiVertexType.BIKEPARK)
            .value("bikeShare", ApiVertexType.BIKESHARE)
    ...
    private void createPlanType() {
        final GraphQLObjectType placeType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(Scalars.GraphQLString)
                        .dataFetcher(environment -> ((ApiPlace) environment.getSource()).name)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("vertexType")
                        ...
                        .type(vertexTypeEnum)
                        .dataFetcher(environment -> ((ApiPlace) environment.getSource()).vertexType)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("latitude")
                        .description("The latitude of the place.")
                        .type(new GraphQLNonNull(Scalars.GraphQLFloat))
                        .dataFetcher(environment -> ((ApiPlace) environment.getSource()).lat)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("longitude")
                        .description("The longitude of the place.")
                        .type(new GraphQLNonNull(Scalars.GraphQLFloat))
                        .dataFetcher(environment -> ((ApiPlace) environment.getSource()).lon)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("quay")
                        .description("The quay related to the place.")
                        .type(quayType)
                        .dataFetcher(environment -> ((ApiPlace) environment.getSource()).vertexType.equals(
                                ApiVertexType.TRANSIT) ? index.stopForId.get(((ApiPlace) environment.getSource()).stopId) : null)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("bikeRentalStation")
                        .type(bikeRentalStationType)
                        ...
                        .dataFetcher(environment -> ((ApiPlace) environment.getSource()).vertexType.equals(
                                ...
                                index.graph.getService(BikeRentalStationService.class)
                                        .getBikeRentalStations()
                                        .stream()
                                        .filter(bikeRentalStation -> bikeRentalStation.id.equals(((ApiPlace) environment.getSource()).bikeShareId))
                                        .findFirst()
                                        .orElse(null)
                                : null)
                        .build())
        ...
        final GraphQLObjectType legType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(dateTimeScalar)
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).startTime.getTime().getTime())
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("endTime")
                        ...
                        .type(dateTimeScalar)
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).endTime.getTime().getTime())
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("aimedStartTime")
                        ...
                        .dataFetcher(// startTime is already adjusted for realtime - need to subtract delay to get aimed time
                                environment -> ((ApiLeg) environment.getSource()).startTime.getTimeInMillis() -
                                        (1000 * ((ApiLeg) environment.getSource()).departureDelay))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .dataFetcher(// endTime is already adjusted for realtime - need to subtract delay to get aimed time
                                environment -> ((ApiLeg) environment.getSource()).endTime.getTimeInMillis() -
                                        (1000 * ((ApiLeg) environment.getSource()).arrivalDelay))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(modeEnum)
                        .dataFetcher(environment -> Enum.valueOf(TraverseMode.class, ((ApiLeg) environment.getSource()).mode))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("transportSubmode")
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).getDuration())
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                    .name("directDuration")
                    .type(Scalars.GraphQLLong)
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(linkGeometryType)
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).legGeometry)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("authority")
                        .description("For ride legs, the service authority used for this legs. For non-ride legs, null.")
                        .type(authorityType)
                        .dataFetcher(environment -> getAgency(((ApiLeg) environment.getSource()).agencyId))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("operator")
                        ...
                        .dataFetcher(
                                environment -> {
                                    FeedScopedId tripId = ((ApiLeg) environment.getSource()).tripId;
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(Scalars.GraphQLBoolean)
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).realTime)
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(Scalars.GraphQLFloat)
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).distance)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("ride")
                        .description("Whether this leg is a ride leg or not.")
                        .type(Scalars.GraphQLBoolean)
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).isTransitLeg())
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("rentedBike")
                        .description("Whether this leg is with a rented bike.")
                        .type(Scalars.GraphQLBoolean)
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).rentedBike)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("fromPlace")
                        .description("The Place where the leg originates.")
                        .type(new GraphQLNonNull(placeType))
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).from)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("toPlace")
                        .description("The Place where the leg ends.")
                        .type(new GraphQLNonNull(placeType))
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).to)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(lineType)
                        .dataFetcher(environment -> index.routeForId.get(((ApiLeg) environment.getSource()).routeId))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("serviceJourney")
                        .description("For ride legs, the service journey. For non-ride legs, null.")
                        .type(serviceJourneyType)
                        .dataFetcher(environment -> index.tripForId.get(((ApiLeg) environment.getSource()).tripId))
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(new GraphQLNonNull(new GraphQLList(quayType)))
                        .dataFetcher(environment -> {
                                List<ApiPlace> stops = ((ApiLeg) environment.getSource()).intermediateStops;
                                if (stops == null) {
                ...
                */
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(new GraphQLNonNull(new GraphQLList(ptSituationElementType)))
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).alertPatches)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("steps")
                        .description("Do we continue from a specified via place")
                        .type(new GraphQLNonNull(new GraphQLList(pathGuidanceType)))
                        .dataFetcher(environment -> ((ApiLeg) environment.getSource()).walkSteps)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
        ...
        final GraphQLObjectType tripPatternType = GraphQLObjectType.newObject()
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(dateTimeScalar)
                        .dataFetcher(environment -> ((ApiItinerary) environment.getSource()).startTime.getTime().getTime())
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("endTime")
                        .description("Time that the trip arrives.")
                        .type(dateTimeScalar)
                        .dataFetcher(environment -> ((ApiItinerary) environment.getSource()).endTime.getTime().getTime())
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("duration")
                        .description("Duration of the trip, in seconds.")
                        .type(Scalars.GraphQLLong)
                        .dataFetcher(environment -> ((ApiItinerary) environment.getSource()).duration)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("directDuration")
                        .description("NOT IMPLEMENTED.")
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(Scalars.GraphQLLong)
                        .dataFetcher(environment -> ((ApiItinerary) environment.getSource()).waitingTime)
                        .build())
                ...
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        ...
                        .type(Scalars.GraphQLLong)
                        .dataFetcher(environment -> ((ApiItinerary) environment.getSource()).walkTime)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("walkDistance")
                        .description("How far the user has to walk, in meters.")
                        .type(Scalars.GraphQLFloat)
                        .dataFetcher(environment -> ((ApiItinerary) environment.getSource()).walkDistance)
                        .build())
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("legs")
                        ...
                        .dataFetcher(environment -> ((ApiItinerary) environment.getSource()).legs)
                        .build())
                /*
                .field(GraphQLFieldDefinition.newFieldDefinition()
                        .name("weight")

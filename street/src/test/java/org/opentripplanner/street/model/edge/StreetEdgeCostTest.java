...
import static org.opentripplanner.street.model.StreetModelFactory.V1;
import static org.opentripplanner.street.model.StreetModelFactory.V2;
...
class StreetEdgeCostTest {
  ...
  public void bikeSafety(VehicleRoutingOptimizeType type, long expectedCost) {
    ...
    var req = StreetSearchRequest.of();
    req.withBike(b -> b.withReluctance(1.0).withOptimizeType(type));

...
/**
 * The main purpose of this class is to be able to return the two new street edges after an edge is
 * split. The first part is called <em>head</em> and the last part is called the <em>tail</em>.
 * <p>

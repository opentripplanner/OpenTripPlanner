 ...
 * <p>
 * This is not just a string in order to conserve memory because many vertices have IDs that have
 * the same prefix.
 */
public sealed interface VertexLabel {
  ...
  /**
   * A vertex label for a subsidiary vertex generated by turn restriction graph application. Must be
   * similar to the parent vertex label so that tests can be written sensibly.
   */

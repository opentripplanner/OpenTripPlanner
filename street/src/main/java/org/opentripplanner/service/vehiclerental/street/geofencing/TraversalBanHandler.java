 ...
 *
 * <p>
 * Distinct from the per-zone {@link GeofencingBoundaryEnforcement} strategies — the answer
 * depends on the priority-resolved view of {@code currentZones} for the state's network, not on any

...
public class TimetableResolverTest {
    ...
    public void testResolve() {
        ...
        resolver.update(pattern, TripUpdateList.forCanceledTrip(pattern.getTrip(0).getId(), 0, today), ITripTimesUpdater);
        ...
        resolver.update(pattern, TripUpdateList.forCanceledTrip(pattern.getTrip(0).getId(), 0, yesterday), ITripTimesUpdater);
    ...
    public void testUpdate() {
        ...
        snapshot.update(pattern, TripUpdateList.forCanceledTrip(pattern.getTrip(0).getId(), 0, yesterday), ITripTimesUpdater);
    }
    ...
    public void testCommit() {
        ...
        assertTrue(resolver.update(pattern, TripUpdateList.forCanceledTrip(pattern.getTrip(0).getId(), 0, today), ITripTimesUpdater));
        ...
        assertTrue(resolver.update(pattern, TripUpdateList.forCanceledTrip(pattern.getTrip(0).getId(), 0, yesterday), ITripTimesUpdater));

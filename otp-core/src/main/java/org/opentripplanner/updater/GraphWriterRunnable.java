 ...
 * GraphUpdaterManager.
 * A few notes:
 * - Don't spend more time in this runnable than necessary, it might block other runnables.
 * - Be aware that while only one runnable of this kind is running to write to the graph, several

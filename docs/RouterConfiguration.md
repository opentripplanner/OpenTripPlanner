...
// router-config.json
{
    ...
    "updaters": [
        ...
        // Polling for GTFS-RT TripUpdates)
        {
            ...
            // automatically updated times are not exposed through APIs. Other options are "REQUIRED" (same as default,
            // but NO_DATA flag is not set) and "ALWAYS" (propagates delays backwards on stops with no estimates

...
| `removeTimeshiftedItinerariesWithSameRoutesAndStops` | Set to true if you want only to see one result per group which goes through the same stops and route, in effect removing the same itineraries but at different time. Set to true if you want to see a greater variety of itineraries rather than the "best" ones.                                                                                                                                                                                                                                                                                                                                                                                                   | boolean         | `false`                                                          | 

...
| `sidewalk=right`                                           | 🚶            |
| `surface=unpaved`                                          | 🚶            |
| `sidewalk=no; maxspeed=55 mph`                             | 🚶            |
| `sidewalk=no; maxspeed=50 mph`                             | 🚶            |
| `sidewalk=no; maxspeed=45 mph`                             | 🚶            |
| `sidewalk=no; maxspeed=40 mph`                             | 🚶            |
| `sidewalk=no; maxspeed=35 mph`                             | 🚶            |
| `sidewalk=no; maxspeed=30 mph`                             | 🚶            |

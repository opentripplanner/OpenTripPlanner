...
-  [Actuator API](sandbox/HealthAPI.md) - API used to check the health status of the OTP instance.
...
- List your extension in the [Available extensions](#Available extensions) section and in the 
  [mydocs config file](https://github.com/opentripplanner/OpenTripPlanner/blob/dev-2.x/mkdocs.yml).

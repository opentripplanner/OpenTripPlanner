...
| frequency                                                             |    `duration`   | How often the data should be downloaded in seconds.                        | *Optional* | `"PT1M"`             |  1.5  |
...
| frequency                                                                             |    `duration`   | How often the data should be updated in seconds.                                | *Optional* | `"PT1M"`      |  1.5  |

...
| `maxInterlineDistance`             | Maximal distance between stops in meters that will connect consecutive trips that are made with same vehicle. Set to -1 to disable interlining.                                                                                                                                  | int            | 200                     | units: meters                                                                             |

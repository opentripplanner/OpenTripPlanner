...
| `timeZone`                         | Time zone for the graph. This is used to store the timetables in the transit model, and to interpret times in incoming requests.                                                                                                                  | string         | null                    | The value can be given either as a zone id, or an UTC offset.                             |

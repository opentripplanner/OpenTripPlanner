...
| `dem`                              | Configure access to elevation data.                                                                                                                                                                                                                                              | array          | null                    |                                                                                           |
...
| `netexDefaults`                    | Default properties for NeTEx feeds.                                                                                                                                                                                                                                              | object         | null                    |                                                                                           |
| `osm`                              | Configure access to OpenStreetMap data.                                                                                                                                                                                                                                          | array          | null                    |                                                                                           |
| `osmDefaults`                      | Default properties for OpenStreetMap feeds.                                                                                                                                                                                                                                      | object         | null                    |                                                                                           |
...
| `transitFeeds`                     | Configure access to data transit data sources  (NeTEx, GTFS).                                                                                                                                                                                                                    | array          | null                    |                                                                                           | 
...
for transit data files in the [base directory](Configuration.md#Base Directory). You can specify data
...
for elevation files in the [base directory](Configuration.md#Base Directory). You can specify data
located outside the local filesystem (including cloud storage services) or at various
different locations around the local filesystem.
...
Alternatively if a relative URI can be provided, it is interpreted as a path relative to the [base directory](Configuration.md#Base Directory).
Example:   

...
| [maxAccessEgressDuration](#routingDefaults_maxAccessEgressDuration)                                                         |       `duration`       | This is the maximum duration for access/egress for street searches.                                                                                                                                                                                                                                                                                                                                                                                                          | *Optional* | `"PT45M"`                |  2.2  |
| [maxDirectStreetDuration](#routingDefaults_maxDirectStreetDuration)                                                         |       `duration`       | This is the maximum duration for a direct street search for each mode.                                                                                                                                                                                                                                                                                                                                                                                                       | *Optional* | `"PT4H"`                 |   na  |
| [maxJourneyDuration](#routingDefaults_maxJourneyDuration)                                                                   |       `duration`       | The expected maximum time a journey can last across all possible journeys for the current deployment.                                                                                                                                                                                                                                                                                                                                                                        | *Optional* | `"PT24H"`                |   na  |
| [modes](/docs/RoutingModes.md)                                                                                              |        `string`        | The set of access/egress/direct/transit modes to be used for the route search.                                                                                                                                                                                                                                                                                                                                                                                               | *Optional* | `"TRANSIT,WALK"`         |   na  |
...
| [transferPenalty](#routingDefaults_transferPenalty)                                                                         |        `integer`       | An additional penalty added to boardings after the first.                                                                                                                                                                                                                                                                                                                                                                                                                    | *Optional* | `0`                      |   na  |
| [transferSlack](#routingDefaults_transferSlack)                                                                             |        `integer`       | The extra time needed to make a safe transfer in seconds.                                                                                                                                                                                                                                                                                                                                                                                                                    | *Optional* | `120`                    |   na  |
...
| [transferOptimization](#routingDefaults_transferOptimization)                                                               |        `object`        | Optimize where a transfer between to trip happens.                                                                                                                                                                                                                                                                                                                                                                                                                           | *Optional* |                          |   na  |
...
| [unpreferred](#routingDefaults_unpreferred)                                                                                 |        `object`        | Parameters listing authorities or lines that preferably should not be used in trip patters.                                                                                                                                                                                                                                                                                                                                                                                  | *Optional* |                          |   na  |
...
<h3 id="routingDefaults_maxJourneyDuration">maxJourneyDuration</h3>

**Since version:** `na` ∙ **Type:** `duration` ∙ **Cardinality:** `Optional` ∙ **Default value:** `"PT24H"`  \
**Path:** /routingDefaults 
...
<h3 id="routingDefaults_transferPenalty">transferPenalty</h3>
...
<h3 id="routingDefaults_transferSlack">transferSlack</h3>

**Since version:** `na` ∙ **Type:** `integer` ∙ **Cardinality:** `Optional` ∙ **Default value:** `120`  \
**Path:** /routingDefaults 

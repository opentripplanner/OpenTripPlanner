...
public class NearestEdgesQuery implements org.apache.thrift.TBase<NearestEdgesQuery, NearestEdgesQuery._Fields>, java.io.Serializable, Cloneable {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("NearestEdgesQuery");
  ...
  static {
    schemes.put(StandardScheme.class, new NearestEdgesQueryStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NearestEdgesQueryTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(NearestEdgesQuery.class, metaDataMap);
  }

  public NearestEdgesQuery() {
    this.max_edges = 10;
   ...
   */
  public NearestEdgesQuery(NearestEdgesQuery other) {
  ...
  public NearestEdgesQuery deepCopy() {
    return new NearestEdgesQuery(this);
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof NearestEdgesQuery)
      return this.equals((NearestEdgesQuery)that);
    return false;
  }

  public boolean equals(NearestEdgesQuery that) {
    if (that == null)
      return false;
  ...
  public int compareTo(NearestEdgesQuery other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    NearestEdgesQuery typedOther = (NearestEdgesQuery)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NearestEdgesQuery(");
    boolean first = true;
  ...
  private static class NearestEdgesQueryStandardSchemeFactory implements SchemeFactory {
    public NearestEdgesQueryStandardScheme getScheme() {
      return new NearestEdgesQueryStandardScheme();
    }
  }

  private static class NearestEdgesQueryStandardScheme extends StandardScheme<NearestEdgesQuery> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NearestEdgesQuery struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                ...
                struct.allowed_modes = new HashSet<org.opentripplanner.api.thrift.definition.TravelMode>(2*_set8.size);
                for (int _i9 = 0; _i9 < _set8.size; ++_i9)
                {
                  org.opentripplanner.api.thrift.definition.TravelMode _elem10; // required
                  _elem10 = org.opentripplanner.api.thrift.definition.TravelMode.findByValue(iprot.readI32());
                  struct.allowed_modes.add(_elem10);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NearestEdgesQuery struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.allowed_modes != null) {
        if (struct.isSetAllowed_modes()) {
          oprot.writeFieldBegin(ALLOWED_MODES_FIELD_DESC);
          {
            ...
            for (org.opentripplanner.api.thrift.definition.TravelMode _iter11 : struct.allowed_modes)
            {
  ...
  private static class NearestEdgesQueryTupleSchemeFactory implements SchemeFactory {
    public NearestEdgesQueryTupleScheme getScheme() {
      return new NearestEdgesQueryTupleScheme();
    }
  }

  private static class NearestEdgesQueryTupleScheme extends TupleScheme<NearestEdgesQuery> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NearestEdgesQuery struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetAllowed_modes()) {
        {
          ...
          for (org.opentripplanner.api.thrift.definition.TravelMode _iter12 : struct.allowed_modes)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NearestEdgesQuery struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.allowed_modes = new HashSet<org.opentripplanner.api.thrift.definition.TravelMode>(2*_set13.size);
          for (int _i14 = 0; _i14 < _set13.size; ++_i14)
          {
            org.opentripplanner.api.thrift.definition.TravelMode _elem15; // required
            _elem15 = org.opentripplanner.api.thrift.definition.TravelMode.findByValue(iprot.readI32());
            struct.allowed_modes.add(_elem15);
          }
        }
        struct.setAllowed_modesIsSet(true);
      }

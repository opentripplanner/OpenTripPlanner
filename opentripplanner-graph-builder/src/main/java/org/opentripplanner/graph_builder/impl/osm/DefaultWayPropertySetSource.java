 ...
 * @see OpenStreetMapGraphBuilderImpl#setDefaultAccessPermissionsSource(props,
...
public class DefaultWayPropertySetSource implements WayPropertySetSource {
	...
	public WayPropertySet getWayPropertySet() {
		...
		setProperties(props, "highway=road", StreetTraversalPermission.ALL, 1,
				1);
		setProperties(props, "highway=byway", StreetTraversalPermission.ALL,
				1.3, 1.3);
		setProperties(props, "highway=track", StreetTraversalPermission.ALL,
				1.3, 1.3);
		setProperties(props, "highway=service", StreetTraversalPermission.ALL,
				1.1, 1.1);
		...
		setProperties(props, "highway=secondary_link",
				StreetTraversalPermission.ALL, 1.5, 1.5);
		setProperties(props, "highway=primary", StreetTraversalPermission.ALL,
				2.06, 2.06);
		...
		/* BICYCLE_AND_CAR */
		/**
		 * trunk and motorway links are often short distances and necessary
		 * connections
		 **/
		...
		/* CAR */
		setProperties(props, "highway=trunk", StreetTraversalPermission.CAR,
				7.47, 7.47);
		setProperties(props, "highway=motorway", StreetTraversalPermission.CAR,
				8, 8);
		...
		setProperties(props, "highway=residential;cycleway=opposite",
				StreetTraversalPermission.ALL, 0.9, 1.1);
		...
		/** Portland area specific tags **/
		setProperties(props,
				"footway=sidewalk;highway=footway;RLIS:bicycle=designated",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE, 1, 1);
		setProperties(props,
				"footway=sidewalk;highway=footway;CCGIS:bicycle=designated",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE, 1, 1);

		/**** special situations *****/

		/*
		 * if service roads are meant to be a bike route, we want to encourage
		 * their use above residential *
		 */
		...
		/** should opposite and opposite_track and opposite_lane be included? **/

		/* cycleway:left=lane */
		setProperties(props, "highway=*;cycleway:left=lane",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
		setProperties(props, "highway=service;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=residential;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=residential_link;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=tertiary;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=tertiary_link;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=secondary;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=secondary_link;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary_link;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=trunk;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		...
		setProperties(props, "highway=*;cycleway:right=track",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
		setProperties(props, "highway=service;cycleway:right=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=residential;cycleway:right=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=residential_link;cycleway:right=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=tertiary;cycleway:right=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=tertiary_link;cycleway:right=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=secondary;cycleway:right=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=secondary_link;cycleway:right=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary;cycleway:right=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary_link;cycleway:right=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=trunk;cycleway:right=track",
				StreetTraversalPermission.ALL);
		...
		setProperties(props, "highway=*;cycleway:left=track",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
		setProperties(props, "highway=service;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=residential;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=residential_link;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=tertiary;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=tertiary_link;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=secondary;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=secondary_link;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary_link;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=trunk;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=trunk_link;cycleway:left=track",
				StreetTraversalPermission.ALL);

		/* cycleway:right=shared_lane */
		setProperties(props, "highway=service;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=residential;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=residential_link;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=tertiary;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=tertiary_link;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=secondary;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=secondary_link;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary_link;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=trunk;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=trunk_link;cycleway:right=shared_lane",
				StreetTraversalPermission.ALL);

		/* cycleway:left=shared_lane */
		setProperties(props, "highway=*;cycleway:left=shared_lane",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
		setProperties(props, "highway=service;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=residential;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=residential_link;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=tertiary;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=tertiary_link;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=secondary;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=secondary_link;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=primary_link;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=trunk;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props, "highway=trunk_link;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		...
		setProperties(props,
				"highway=*;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
		setProperties(props,
				"highway=service;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=residential;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL, 0.77, 0.7);
		setProperties(
				props,
				"highway=residential_link;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL, 0.77, 0.7);
		setProperties(props,
				"highway=tertiary;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=tertiary_link;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=secondary;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=secondary_link;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=primary;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=primary_link;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=trunk;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=trunk_link;cycleway:right=lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		...
		setProperties(props,
				"highway=*;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
		setProperties(props,
				"highway=service;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=residential;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL, 0.7, 0.77);
		setProperties(
				props,
				"highway=residential_link;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL, 0.7, 0.77);
		setProperties(props,
				"highway=tertiary;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=tertiary_link;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=secondary;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=secondary_link;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=primary;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=primary_link;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=trunk;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=trunk_link;cycleway:right=track;cycleway:left=lane",
				StreetTraversalPermission.ALL);

		/* cycleway:right=track, cycleway:left=shared_lane */
		setProperties(props,
				"highway=*;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
		setProperties(
				props,
				"highway=service;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=residential;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=residential_link;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=tertiary;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=tertiary_link;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=secondary;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=secondary_link;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=primary;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=primary_link;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=trunk;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=trunk_link;cycleway:right=track;cycleway:left=shared_lane",
				StreetTraversalPermission.ALL);

		/* cycleway:right=shared_lane, cycleway:left=lane */
		setProperties(props,
				"highway=*;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
		setProperties(
				props,
				"highway=service;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=residential;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=residential_link;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=tertiary;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=tertiary_link;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=secondary;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=secondary_link;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=primary;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=primary_link;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=trunk;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=trunk_link;cycleway:right=shared_lane;cycleway:left=lane",
				StreetTraversalPermission.ALL);

		/* cycleway:right=shared_lane, cycleway:left=track */
		setProperties(props,
				"highway=*;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
		setProperties(
				props,
				"highway=service;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=residential;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=residential_link;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=tertiary;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=tertiary_link;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=secondary;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=secondary_link;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=primary;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=primary_link;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(props,
				"highway=trunk;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		setProperties(
				props,
				"highway=trunk_link;cycleway:right=shared_lane;cycleway:left=track",
				StreetTraversalPermission.ALL);
		...
		setProperties(props, "surface=sand", StreetTraversalPermission.ALL,
				100.0, 100.0, true);

		/* unpaved, etc */
		setProperties(props, "surface=unpaved", StreetTraversalPermission.ALL,
				1.18, 1.18, true);
		...
		setProperties(props, "surface=pebblestone",
				StreetTraversalPermission.ALL, 1.5, 1.5, true);
		setProperties(props, "surface=ground", StreetTraversalPermission.ALL,
				1.5, 1.5, true);
		setProperties(props, "surface=dirt", StreetTraversalPermission.ALL,
				1.5, 1.5, true);
		setProperties(props, "surface=earth", StreetTraversalPermission.ALL,
				1.5, 1.5, true);
		setProperties(props, "surface=grass", StreetTraversalPermission.ALL,
				1.5, 1.5, true);
		setProperties(props, "surface=mud", StreetTraversalPermission.ALL, 1.5,
				1.5, true);
		setProperties(props, "surface=wood", StreetTraversalPermission.ALL,
				1.5, 1.5, true);
		setProperties(props, "surface=metal", StreetTraversalPermission.ALL,
				1.5, 1.5, true);
		setProperties(props, "surface=artifical_turf",
				StreetTraversalPermission.ALL, 1.5, 1.5, true);

		// it is extremely unsafe to ride directly on the Scotsman
		setProperties(props, "surface=tartan", StreetTraversalPermission.ALL,
				3.0, 3.0, true);
		...
		createNames(props, "highway=service;service=parking_aisle",
				"parking lot");
	...
	private void setProperties(WayPropertySet propset, String spec,
			StreetTraversalPermission permission, double safety,
			double safetyBack) {
	...
	private void setProperties(WayPropertySet propset, String spec,
			StreetTraversalPermission permission, double safety,
			double safetyBack, boolean mixin) {

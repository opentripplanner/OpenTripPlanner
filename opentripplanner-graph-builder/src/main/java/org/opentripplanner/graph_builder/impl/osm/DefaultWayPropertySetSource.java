...
public class DefaultWayPropertySetSource implements WayPropertySetSource {
    ...
    public WayPropertySet getWayPropertySet() {
        ...
        setProperties(props, "highway=residential;cycleway:right=shared_lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential_link;cycleway:right=shared_lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary;cycleway:right=shared_lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary_link;cycleway:right=shared_lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary;cycleway:right=shared_lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary_link;cycleway:right=shared_lane", 
                StreetTraversalPermission.ALL);
        ...
        setProperties(props, "highway=residential;cycleway:left=shared_lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential_link;cycleway:left=shared_lane",
            StreetTraversalPermission.ALL);
        ...
        setProperties(props, "highway=secondary;cycleway:left=shared_lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary_link;cycleway:left=shared_lane", 
                StreetTraversalPermission.ALL);
        ...
        setProperties(props, "highway=*;cycleway:right=lane;cycleway:left=track",
                StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
        setProperties(props, "highway=service;cycleway:right=lane;cycleway:left=track",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential;cycleway:right=lane;cycleway:left=track",
            StreetTraversalPermission.ALL, 0.77, 0.7);
        setProperties(props, "highway=residential_link;cycleway:right=lane;cycleway:left=track",
            StreetTraversalPermission.ALL, 0.77, 0.7);
        setProperties(props, "highway=tertiary;cycleway:right=lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary_link;cycleway:right=lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary;cycleway:right=lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary_link;cycleway:right=lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary;cycleway:right=lane;cycleway:left=track", 
                      StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary_link;cycleway:right=lane;cycleway:left=track",
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk;cycleway:right=lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk_link;cycleway:right=lane;cycleway:left=track",
            StreetTraversalPermission.ALL);
        ...
        setProperties(props, "highway=*;cycleway:right=track;cycleway:left=lane",
                StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
        setProperties(props, "highway=service;cycleway:right=track;cycleway:left=lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential;cycleway:right=track;cycleway:left=lane",
            StreetTraversalPermission.ALL, 0.7, 0.77);
        setProperties(props, "highway=residential_link;cycleway:right=track;cycleway:left=lane",
            StreetTraversalPermission.ALL, 0.7, 0.77);
        setProperties(props, "highway=tertiary;cycleway:right=track;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary_link;cycleway:right=track;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary;cycleway:right=track;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary_link;cycleway:right=track;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary;cycleway:right=track;cycleway:left=lane", 
                      StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary_link;cycleway:right=track;cycleway:left=lane",
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk;cycleway:right=track;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk_link;cycleway:right=track;cycleway:left=lane",
            StreetTraversalPermission.ALL);


        /* cycleway:right=track, cycleway:left=shared_lane */
        setProperties(props, "highway=*;cycleway:right=track;cycleway:left=shared_lane",
                StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
        setProperties(props, "highway=service;cycleway:right=track;cycleway:left=shared_lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential;cycleway:right=track;cycleway:left=shared_lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential_link;cycleway:right=track;cycleway:left=shared_lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary;cycleway:right=track;cycleway:left=shared_lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary_link;cycleway:right=track;cycleway:left=shared_lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary;cycleway:right=track;cycleway:left=shared_lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary_link;cycleway:right=track;cycleway:left=shared_lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary;cycleway:right=track;cycleway:left=shared_lane", 
                      StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary_link;cycleway:right=track;cycleway:left=shared_lane",
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk;cycleway:right=track;cycleway:left=shared_lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk_link;cycleway:right=track;cycleway:left=shared_lane",
            StreetTraversalPermission.ALL);

        /* cycleway:right=shared_lane, cycleway:left=lane */
        setProperties(props, "highway=*;cycleway:right=shared_lane;cycleway:left=lane",
                StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
        setProperties(props, "highway=service;cycleway:right=shared_lane;cycleway:left=lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential;cycleway:right=shared_lane;cycleway:left=lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential_link;cycleway:right=shared_lane;cycleway:left=lane",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary;cycleway:right=shared_lane;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary_link;cycleway:right=shared_lane;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary;cycleway:right=shared_lane;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary_link;cycleway:right=shared_lane;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary;cycleway:right=shared_lane;cycleway:left=lane", 
                      StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary_link;cycleway:right=shared_lane;cycleway:left=lane",
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk;cycleway:right=shared_lane;cycleway:left=lane", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk_link;cycleway:right=shared_lane;cycleway:left=lane",
            StreetTraversalPermission.ALL);

        /* cycleway:right=shared_lane, cycleway:left=track */
        setProperties(props, "highway=*;cycleway:right=shared_lane;cycleway:left=track",
                StreetTraversalPermission.PEDESTRIAN_AND_BICYCLE);
        setProperties(props, "highway=service;cycleway:right=shared_lane;cycleway:left=track",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential;cycleway:right=shared_lane;cycleway:left=track",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=residential_link;cycleway:right=shared_lane;cycleway:left=track",
            StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary;cycleway:right=shared_lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=tertiary_link;cycleway:right=shared_lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary;cycleway:right=shared_lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=secondary_link;cycleway:right=shared_lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary;cycleway:right=shared_lane;cycleway:left=track", 
                      StreetTraversalPermission.ALL);
        setProperties(props, "highway=primary_link;cycleway:right=shared_lane;cycleway:left=track",
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk;cycleway:right=shared_lane;cycleway:left=track", 
                StreetTraversalPermission.ALL);
        setProperties(props, "highway=trunk_link;cycleway:right=shared_lane;cycleway:left=track",
            StreetTraversalPermission.ALL);

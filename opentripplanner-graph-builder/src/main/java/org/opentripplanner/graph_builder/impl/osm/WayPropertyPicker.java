...
public class WayPropertyPicker {
    ...
    /**
     * If this value is true, and this picker's specifier applies to a given way, then this is never
     * chosen as the most applicable value, and the final safety should be multiplied by this value.

...
otp.locale.French = {
    ...
    config : {
        ...
        rightClickMsg : "Cliquez-droit sur la carte pour désigner le départ et l'arrivée de votre parcours.",
        attribution : {
    ...
    contextMenu : {
        ...
        analysisLocation    : "Définir comme origine de l'analyse",

        minimize            : "Minimiser",
        bringToFront        : "Placer au dessus",
        sendToBack          : "Placer en dessous"
    },
    ...
    widgets : 
    {
        managerMenu : 
        {
            minimizeAll     : "Tout minimiser",
            unminimizeAll   : "Tout restaurer"
        },

        ItinerariesWidget : 
        {
            title               : "Itineraires",
            itinerariesLength   : "Itineraires trouvés",
            linkToSearch        : "Lien vers cette recherche",
            buttons             :
            {
                first           : "Premier",
                previous        : "Précédent",
        ...
        AnalystLegend :
        {
            title               : "Légende : temps de trajet en minutes"
        },
    ...
    instructions : {
        ...
        presets_label : "Val. pré-définies",

        preferredRoutes_label : "Itinéraires préférés",
        edit : "Modifier",
        none : "Aucune",
        weight : "Pondération",
    ...
    tripPlanner : {
        labels : {
            ...
            maxWalkDistance : "Marcher au maximum",

...
otp.util.ParseUrlParams = {
    ...
    getUrl : function()
    {
        ...
        // prefer the new, hash-based URL to the old GET-based URL. The logic is that, if
        // someone send out a GET-style URL, someone else opens it, modifies it and sends it to
        // a third party, the hash mod should be preferred. At some point GET-style URLs should
        // be removed altogether; they are no longer generated by link-to-trip.
        return fromHash.length != 0 ? fromHash : fromSubstring;
    },

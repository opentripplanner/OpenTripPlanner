...
otp.locale.Hebrew = {
    ...
    config :
    {
        ...
        rightClickMsg : "יש ללחוץ על המפה במקש ימני כדי להקצות את נקודות ההתחלה והסיום של הטיול שלך.",
        attribution   : {
            title   : "היקף הרישיון",
            content : "כאן יופיע כתב הוויתור"
        }
    },

    contextMenu : 
    {
        fromHere         : "להתחיל בטיול מכאן",
        toHere           : "לסיים את הטיול כאן",
    ...
    {
        reverse       : "היפוך",
        reverseTip    : "<b>היפוך הכיוונים</b><br/>תכנון טיול חזרה על ידי היפוך מיקומי ההתחלה והסיום של טיול זה והתאמה לפי פרק הזמן הבא.",
        reverseMiniTip: "היפוך הכיוונים",

        edit          : "עריכה",
        editTip       : "<b>עריכת הטיול</b><br/>חזרה לקלט תכנון הטיול הראשי עם פרטי טיול זה.",

        clear         : "מחיקה",
        clearTip      : "<b>מחיקה</b><br/>מחיקת המפה ואת כל הכלים הפעילים.",

        fullScreen    : "מסך מלא",
        fullScreenTip : "<b>מסך מלא</b><br/>הצגה -או- הסתרה של סרגלי הכלים",

        print         : "הדפסה",
        printTip      : "<b>הדפסה</b><br/>הדפסת גרסה ידידותית של תכנית הטיול (ללא המפה).",

        link          : "קישור",
        linkTip      : "<b>קישור</b><br/>הצגת כתובת הקישור עבור תכנית טיול זאת.",
    ...
    tripPlanner :
    {
        ...
        labels : 
        {
            panelTitle    : "מתכנן הטיולים",
            tabTitle      : "תכנון טיול",
            inputTitle    : "פרטי הטיול",
            optTitle      : "העדפות הטיול (רשות)",
            submitMsg     : "הטיול שלך מתוכנן...",
            optionalTitle : "",
            date          : "תאריך",
            time          : "שעה",
            when          : "מתי",
            ...
            mode          : "טיול באמצעות",
            wheelchair    : "טיול נגיש לכיסא גלגלים", 
            go            : "לדרך",
            planTrip      : "תכנוןה טיול שלך",
            newTrip       : "טיול חדש"
        },
        ...
        link : 
        {
            text           : "קישור לטיול זה (OTP)",
            trip_separator : "טיול זה במתכנני תחבורה ציבורית שונים",
            bike_separator : "במתכנני טיולי אופניים שונים",
        ...
        geocoder:
        {
            ...
            msg_title    : "סקירת תכנית הטיול",
            msg_content  : "נא לתקן את השגיאות לפני תכנון הטיול שלך",
        ...
        error:
        {
            title        : 'שגיאה במתכנן הטיולים',
            deadMsg      : "תכנון הטיול במפות אינו מגיב כעת. נא להמתין מספר דקות ולנסות שוב, או לנסות את מתכנן הטיולים הטקסטואלי (קישור להלן).",
            geoFromMsg   : "נא לבחור את מיקום ה'מוצא' של הטיול שלך: ",
            geoToMsg     : "נא לבחור את מיקום ה'יעד' של הטיול שלך: "
        },
        ...
        [
          ...
          ['QUICK',     'טיול מהיר'],
          ['SAFE',      'טיול ידידותי לאופניים'],
          ['TRIANGLE',  'טיול בהתאמה אישית...']
        ],

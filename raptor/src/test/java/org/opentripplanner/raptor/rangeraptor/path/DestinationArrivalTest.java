...
public class DestinationArrivalTest {
   ...
   */
  private static final McStopArrival<RaptorTripSchedule> ACCESS_ARRIVAL = STOP_ARRIVAL_FACTORY
    .createAccessStopArrival(ACCESS_DEPARTURE_TIME, ACCESS_WALK);

  private static final ArrivalView<RaptorTripSchedule> TRANSIT_ARRIVAL = STOP_ARRIVAL_FACTORY
    .createTransitStopArrival(

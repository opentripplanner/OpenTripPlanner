 ...
 * <p/>The result is returned as a multi-line string.
 * <p/>If the header line exceeds 2000 characters and you compare all elements the comparison is
 * aborted.
 * <p/>Both regular numbers and time is supported. The time uses the

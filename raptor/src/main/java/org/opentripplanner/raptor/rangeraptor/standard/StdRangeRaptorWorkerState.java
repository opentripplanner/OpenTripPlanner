...
public final class StdRangeRaptorWorkerState<T extends RaptorTripSchedule> implements
   ...
   * <p/>PLEASE OVERRIDE!
   * <p/>The implementation here is not correct - please override if you plan to use any result
   * paths or "rounds" as "number of transfers". The implementation is OK if the only thing you care

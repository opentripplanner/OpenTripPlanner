...
public class RoundTracker {
   ...
   * <p/>This is default set to the maximum number of rounds limit, but as soon as the destination
   * is reach the {@link #numberOfAdditionalTransfers} is used to update the limit.
   * <p/>The limit is inclusive, indicating the last round to process.
   */

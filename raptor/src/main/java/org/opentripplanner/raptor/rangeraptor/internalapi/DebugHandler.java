 ...
 * <p/>The implementation of this interface will take these events and report them back to the API
...
public interface DebugHandler<T> {
   ...
   * <p/>The handler will do the last check to see if this stop is in the request stop list or in
   * debug request path.
   */
   ...
   * <p/>The same check as in {@link #accept(Object)} is performed before reporting back to the API
   * listeners.
   *

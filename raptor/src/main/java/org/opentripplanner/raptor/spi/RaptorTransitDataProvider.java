...
public interface RaptorTransitDataProvider<T extends RaptorTripSchedule> {
   ...
   * around that stop.
   * <p/>The implementation may implement a lightweight {@link RaptorTransfer} representation. The
   ...
   * <p/>The implementation may implement a lightweight {@link RaptorTripPattern} representation.

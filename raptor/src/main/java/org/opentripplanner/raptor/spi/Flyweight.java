 ...
 * choose not to implement the return type as a flyweight object, but the Raptor implementation is
 * guaranteed to treat them as such - enabling the optimization.
 * <p>
 ...
 * Do not store a reference to flyweight objects and make sure you do not access the state after the
 * next method call.
 * <p>

...
public interface RaptorTransferConstraint {
   ...
   * a constraint only apply to specific trips, then the {@link RaptorConstrainedBoardingSearch} is
   * reponsible for NOT returning the NOT-ALLOWED transfer, and finding the next ALLOWED trip.
   */

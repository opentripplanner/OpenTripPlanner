...
/**
 * This interface enable the transit layer to override the normal trip search in Raptor. Each
 * {@link RaptorRoute} may provide an instance of this interface so Raptor can ask for a
 * bord-/alight- event with the route as the target.
 * <p>

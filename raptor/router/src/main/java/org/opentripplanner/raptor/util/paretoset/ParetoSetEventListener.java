 ...
 * <p>
 * When an element is accepted(added), other elements might get dropped. An element is dropped if
 * it is dominated by the new element.
 * <p>
 ...
 * dropped events.
 * <p>
 * To subscribe to these events, implement this interface and register it with the
 * {@link ParetoSet}.
 *
